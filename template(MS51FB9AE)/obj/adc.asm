...
;	adc.c:7: ADCCON1 |= (1 << 0);
	orl	_ADCCON1,#0x01
;	adc.c:9: ADCCON1 &= ~(0x30);
	anl	_ADCCON1,#0xcf
;	adc.c:10: ADCCON1 |= 0x30;
	orl	_ADCCON1,#0x30
;	adc.c:12: P1M1 |= (1 << 7);
	orl	_P1M1,#0x80
;	adc.c:13: P1M2 &= ~(1 << 7);
	anl	_P1M2,#0x7f
;	adc.c:14: AINDIDS |= (1 << 0);
	orl	_AINDIDS,#0x01
;	adc.c:15: EADC = 1;
;	assignBit
	setb	_EADC
...
;------------------------------------------------------------
;	adc.c:18: void ADC_SelectChannel(uint8_t u8Channel)
;	-----------------------------------------
;	 function ADC_SelectChannel
;	-----------------------------------------
_ADC_SelectChannel:
	mov	r7,dpl
;	adc.c:20: ADCCON0 &= ~(0x0F);
	anl	_ADCCON0,#0xf0
;	adc.c:21: ADCCON0 |= (u8Channel & 0x07);
	anl	ar7,#0x07
	mov	a,r7
	orl	_ADCCON0,a
;	adc.c:22: }
...
;------------------------------------------------------------
;	adc.c:24: void ADC_StartConv(void)
;	-----------------------------------------
...
;------------------------------------------------------------
;	adc.c:29: uint8_t ADC_IsBusy(void)
;	-----------------------------------------
;	 function ADC_IsBusy
;	-----------------------------------------
_ADC_IsBusy:
;	adc.c:31: return ADCS;
	mov	c,_ADCS
	clr	a
	rlc	a
	mov	dpl,a
...
;------------------------------------------------------------
;	adc.c:34: uint16_t ADC_GetData(void)
;	-----------------------------------------
;	 function ADC_GetData
;	-----------------------------------------
_ADC_GetData:
;	adc.c:36: return (ADCRH * 16 + (ADCRL & 0x0F));
	mov	r6,_ADCRH
	clr	a
	swap	a
	anl	a,#0xf0
...
;------------------------------------------------------------
;	adc.c:39: void ADC_ClearFlag(void)
;	-----------------------------------------
...
;------------------------------------------------------------
;	adc.c:44: void ADC_Enable(void)
;	-----------------------------------------
;	 function ADC_Enable
;	-----------------------------------------
_ADC_Enable:
;	adc.c:46: ADCCON1 |= (1 << 0);
	orl	_ADCCON1,#0x01
;	adc.c:47: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	adc.c:49: void ADC_Disable(void)
;	-----------------------------------------
;	 function ADC_Disable
;	-----------------------------------------
_ADC_Disable:
;	adc.c:51: ADCCON1 &= ~(1 << 0);
	anl	_ADCCON1,#0xfe
;	adc.c:52: }
	ret
	.area CSEG    (CODE)
