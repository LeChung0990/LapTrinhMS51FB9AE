      ...
      0001E1 43 C4 20         [24]  579 	orl	_T3CON,#0x20
                                    580 ;	lib/src/uart0.c:11: T3CON &= ~0x07;
      0001E4 53 C4 F8         [24]  581 	anl	_T3CON,#0xf8
                                    582 ;	lib/src/uart0.c:12: T3CON |= 0x00;
      0001E7 85 C4 C4         [24]  583 	mov	_T3CON,_T3CON
                                    584 ;	lib/src/uart0.c:14: EIE1 &= ~(1 << 1);
      0001EA 53 9C FD         [24]  585 	anl	_EIE1,#0xfd
                                    586 ;	lib/src/uart0.c:15: RH3 = 0xff;
      0001ED 75 C6 FF         [24]  587 	mov	_RH3,#0xff
                                    588 ;	lib/src/uart0.c:16: RL3 = 0xf7;
      0001F0 75 C5 F7         [24]  589 	mov	_RL3,#0xf7
                                    590 ;	lib/src/uart0.c:17: T3CON |= (1 << 3);
      0001F3 43 C4 08         [24]  591 	orl	_T3CON,#0x08
                                    592 ;	lib/src/uart0.c:18: PCON |= (1 << 7);
      0001F6 43 87 80         [24]  593 	orl	_PCON,#0x80
                                    594 ;	lib/src/uart0.c:20: P06 = 1;
                                    595 ;	assignBit
      0001F9 D2 86            [12]  596 	setb	_P06
                                    597 ;	lib/src/uart0.c:21: P0M1 &= ~(1 << 6);
      0001FB 53 B1 BF         [24]  598 	anl	_P0M1,#0xbf
                                    599 ;	lib/src/uart0.c:22: P0M2 |= (1 << 6);
      0001FE 43 B2 40         [24]  600 	orl	_P0M2,#0x40
                                    601 ;	lib/src/uart0.c:23: P07 = 1;
                                    602 ;	assignBit
      000201 D2 87            [12]  603 	setb	_P07
                                    604 ;	lib/src/uart0.c:24: P0M1 &= ~(1 << 7);
      000203 53 B1 7F         [24]  605 	anl	_P0M1,#0x7f
                                    606 ;	lib/src/uart0.c:25: P0M2 &= ~(1 << 7);
      000206 53 B2 7F         [24]  607 	anl	_P0M2,#0x7f
                                    608 ;	lib/src/uart0.c:27: PCON &= ~(1 << 6);
      000209 53 87 BF         [24]  609 	anl	_PCON,#0xbf
                                    610 ;	lib/src/uart0.c:28: SM0 = 0;
                                    611 ;	assignBit
      00020C C2 9F            [12]  612 	clr	_SM0
                                    613 ;	lib/src/uart0.c:29: SM1 = 1;
                                    614 ;	assignBit
      00020E D2 9E            [12]  615 	setb	_SM1
                                    616 ;	lib/src/uart0.c:31: REN = 1;
                                    617 ;	assignBit
      000210 D2 9C            [12]  618 	setb	_REN
                                    619 ;	lib/src/uart0.c:32: }
      000212 22               [24]  620 	ret
                                    621 ;------------------------------------------------------------
                                    622 ;Allocation info for local variables in function 'UART0_SendData'
                                    623 ;------------------------------------------------------------
                                    624 ;u8Data                    Allocated to registers 
                                    625 ;------------------------------------------------------------
                                    626 ;	lib/src/uart0.c:34: void UART0_SendData(uint8_t u8Data)
                                    627 ;	-----------------------------------------
                                    628 ;	 function UART0_SendData
                                    629 ;	-----------------------------------------
      000213                        630 _UART0_SendData:
      000213 85 82 99         [24]  631 	mov	_SBUF,dpl
                                    632 ;	lib/src/uart0.c:36: SBUF = u8Data;
                                    633 ;	lib/src/uart0.c:37: }
      000216 22               [24]  634 	ret
                                    635 ;------------------------------------------------------------
                                    636 ;Allocation info for local variables in function 'UART0_GetData'
                                    637 ;------------------------------------------------------------
                                    638 ;	lib/src/uart0.c:39: uint8_t UART0_GetData(void)
                                    639 ;	-----------------------------------------
                                    640 ;	 function UART0_GetData
                                    641 ;	-----------------------------------------
      000217                        642 _UART0_GetData:
                                    643 ;	lib/src/uart0.c:41: return SBUF;
      000217 85 99 82         [24]  644 	mov	dpl,_SBUF
                                    645 ;	lib/src/uart0.c:42: }
      00021A 22               [24]  646 	ret
                                    647 ;------------------------------------------------------------
                                    648 ;Allocation info for local variables in function 'UART0_EnableInterrupt'
                                    649 ;------------------------------------------------------------
                                    650 ;	lib/src/uart0.c:44: void UART0_EnableInterrupt(void)
                                    651 ;	-----------------------------------------
                                    652 ;	 function UART0_EnableInterrupt
                                    653 ;	-----------------------------------------
      00021B                        654 _UART0_EnableInterrupt:
                                    655 ;	lib/src/uart0.c:46: ES = 1;
                                    656 ;	assignBit
      00021B D2 AC            [12]  657 	setb	_ES
                                    658 ;	lib/src/uart0.c:47: }
      00021D 22               [24]  659 	ret
                                    660 ;------------------------------------------------------------
                                    661 ;Allocation info for local variables in function 'UART0_DisableInterrupt'
                                    662 ;------------------------------------------------------------
                                    663 ;	lib/src/uart0.c:49: void UART0_DisableInterrupt(void)
                                    664 ;	-----------------------------------------
                                    665 ;	 function UART0_DisableInterrupt
                                    666 ;	-----------------------------------------
      00021E                        667 _UART0_DisableInterrupt:
                                    668 ;	lib/src/uart0.c:51: ES = 0;
                                    669 ;	assignBit
      00021E C2 AC            [12]  670 	clr	_ES
                                    671 ;	lib/src/uart0.c:52: }
      000220 22               [24]  672 	ret
                                    673 ;------------------------------------------------------------
                                    674 ;Allocation info for local variables in function 'UART0_ClearFlag'
                                    675 ;------------------------------------------------------------
                                    676 ;u8Flag                    Allocated to registers r7 
                                    677 ;------------------------------------------------------------
                                    678 ;	lib/src/uart0.c:54: void UART0_ClearFlag(uint8_t u8Flag)
                                    679 ;	-----------------------------------------
                                    680 ;	 function UART0_ClearFlag
                                    681 ;	-----------------------------------------
      000221                        682 _UART0_ClearFlag:
                                    683 ;	lib/src/uart0.c:56: SCON &= ~(u8Flag);
      000221 E5 82            [12]  684 	mov	a,dpl
      000223 F4               [12]  685 	cpl	a
      000224 52 98            [12]  686 	anl	_SCON,a
                                    687 ;	lib/src/uart0.c:57: }
      000226 22               [24]  688 	ret
                                    689 ;------------------------------------------------------------
                                    690 ;Allocation info for local variables in function 'UART0_GetFlag'
                                    691 ;------------------------------------------------------------
                                    692 ;u8Flag                    Allocated to registers r7 
                                    693 ;------------------------------------------------------------
                                    694 ;	lib/src/uart0.c:59: uint8_t UART0_GetFlag(uint8_t u8Flag)
                                    695 ;	-----------------------------------------
                                    696 ;	 function UART0_GetFlag
                                    697 ;	-----------------------------------------
      000227                        698 _UART0_GetFlag:
                                    699 ;	lib/src/uart0.c:61: if (SCON & (u8Flag)) {
      000227 E5 82            [12]  700 	mov	a,dpl
      000229 55 98            [12]  701 	anl	a,_SCON
      00022B 60 04            [24]  702 	jz	00102$
                                    703 ;	lib/src/uart0.c:62: return 1;
      00022D 75 82 01         [24]  704 	mov	dpl,#0x01
      000230 22               [24]  705 	ret
      000231                        706 00102$:
                                    707 ;	lib/src/uart0.c:64: return 0;
      000231 75 82 00         [24]  708 	mov	dpl,#0x00
                                    709 ;	lib/src/uart0.c:66: }
      000234 22               [24]  710 	ret
                                    711 	.area CSEG    (CODE)
                                    712 	.area CONST   (CODE)
                                    713 	.area XINIT   (CODE)
