      ...
      0002B2 43 8E 08         [24]  576 	orl	_CKCON,#0x08
                                    577 ;	delay.c:7: ENABLE_TIMER0_MODE1; // Timer0 is 16-bit mode
      0002B5 53 89 F0         [24]  578 	anl	_TMOD,#0xF0
      0002B8 43 89 01         [24]  579 	orl	_TMOD,#0x01
      0002BB 22               [24]  580 	ret
                                    581 ;------------------------------------------------------------
                                    ...
                                    592 ;	-----------------------------------------
      0002BC                        593 _DelayT0:
      0002BC AE 82            [24]  594 	mov	r6,dpl
      0002BE AF 83            [24]  595 	mov	r7,dph
                                    596 ;	delay.c:19: TL0TMP = LOBYTE(65535 - (16 * configdelay));
      0002C0 E5 46            [12]  597 	mov	a,_DelayT0_PARM_2
      0002C2 C4               [12]  598 	swap	a
      0002C3 54 F0            [12]  599 	anl	a,#0xF0
      0002C5 FD               [12]  600 	mov	r5,a
      0002C6 74 FF            [12]  601 	mov	a,#0xFF
      0002C8 C3               [12]  602 	clr	c
      0002C9 9D               [12]  603 	subb	a,r5
      0002CA FD               [12]  604 	mov	r5,a
                                    605 ;	delay.c:20: TH0TMP = HIBYTE(65535 - (16 * configdelay));
      0002CB AB 46            [24]  606 	mov	r3,_DelayT0_PARM_2
      0002CD E5 47            [12]  607 	mov	a,(_DelayT0_PARM_2 + 1)
      0002CF C4               [12]  608 	swap	a
      0002D0 54 F0            [12]  609 	anl	a,#0xF0
      0002D2 CB               [12]  610 	xch	a,r3
      0002D3 C4               [12]  611 	swap	a
      0002D4 CB               [12]  612 	xch	a,r3
      0002D5 6B               [12]  613 	xrl	a,r3
      0002D6 CB               [12]  614 	xch	a,r3
      0002D7 54 F0            [12]  615 	anl	a,#0xF0
      0002D9 CB               [12]  616 	xch	a,r3
      0002DA 6B               [12]  617 	xrl	a,r3
      0002DB FC               [12]  618 	mov	r4,a
      0002DC 8B 01            [24]  619 	mov	ar1,r3
      0002DE 8C 02            [24]  620 	mov	ar2,r4
      0002E0 E4               [12]  621 	clr	a
      0002E1 FB               [12]  622 	mov	r3,a
      0002E2 FC               [12]  623 	mov	r4,a
      0002E3 74 FF            [12]  624 	mov	a,#0xFF
      0002E5 C3               [12]  625 	clr	c
      0002E6 99               [12]  626 	subb	a,r1
      0002E7 F9               [12]  627 	mov	r1,a
      0002E8 74 FF            [12]  628 	mov	a,#0xFF
      0002EA 9A               [12]  629 	subb	a,r2
      0002EB FA               [12]  630 	mov	r2,a
      0002EC E4               [12]  631 	clr	a
      0002ED 9B               [12]  632 	subb	a,r3
      0002EE FB               [12]  633 	mov	r3,a
      0002EF E4               [12]  634 	clr	a
      0002F0 9C               [12]  635 	subb	a,r4
      0002F1 8A 04            [24]  636 	mov	ar4,r2
                                    637 ;	delay.c:21: while (u16Count)
      0002F3                        638 00104$:
      0002F3 EE               [12]  639 	mov	a,r6
      0002F4 4F               [12]  640 	orl	a,r7
      0002F5 60 14            [24]  641 	jz	00107$
                                    642 ;	delay.c:23: TL0 = TL0TMP;
      0002F7 8D 8A            [24]  643 	mov	_TL0,r5
                                    644 ;	delay.c:24: TH0 = TH0TMP;
      0002F9 8C 8C            [24]  645 	mov	_TH0,r4
                                    646 ;	delay.c:25: set_TCON_TR0; // Start Timer0
      0002FB D2 8C            [12]  647 	setb	_TR0
                                    648 ;	delay.c:26: while (!TF0); // Check Timer0 Time-Out Flag
      0002FD                        649 00101$:
                                    650 ;	delay.c:27: clr_TCON_TF0;
      0002FD 10 8D 02         [24]  651 	jbc	_TF0,00123$
      000300 80 FB            [24]  652 	sjmp	00101$
      000302                        653 00123$:
                                    654 ;	delay.c:28: clr_TCON_TR0; // Stop Timer0
      000302 C2 8C            [12]  655 	clr	_TR0
                                    656 ;	delay.c:29: --u16Count;
      000304 1E               [12]  657 	dec	r6
      000305 BE FF 01         [24]  658 	cjne	r6,#0xFF,00124$
      000308 1F               [12]  659 	dec	r7
      000309                        660 00124$:
      000309 80 E8            [24]  661 	sjmp	00104$
      00030B                        662 00107$:
      00030B 22               [24]  663 	ret
                                    664 	.area CSEG    (CODE)
                                    665 	.area CONST   (CODE)
                                    666 	.area XINIT   (CODE)
