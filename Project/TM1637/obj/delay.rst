      ...
      0001D1 43 8E 08         [24]  575 	orl	_CKCON,#0x08
                                    576 ;	lib/src/delay.c:7: ENABLE_TIMER0_MODE1; // Timer0 is 16-bit mode
      0001D4 53 89 F0         [24]  577 	anl	_TMOD,#0xf0
      0001D7 43 89 01         [24]  578 	orl	_TMOD,#0x01
                                    579 ;	lib/src/delay.c:8: }
      0001DA 22               [24]  580 	ret
                                    581 ;------------------------------------------------------------
                                    ...
                                    592 ;	-----------------------------------------
      0001DB                        593 _DelayT0:
      0001DB AE 82            [24]  594 	mov	r6,dpl
      0001DD AF 83            [24]  595 	mov	r7,dph
                                    596 ;	lib/src/delay.c:19: TL0TMP = LOBYTE(65535 - (16 * configdelay));
      0001DF E5 12            [12]  597 	mov	a,_DelayT0_PARM_2
      0001E1 C4               [12]  598 	swap	a
      0001E2 54 F0            [12]  599 	anl	a,#0xf0
      0001E4 FD               [12]  600 	mov	r5,a
      0001E5 74 FF            [12]  601 	mov	a,#0xff
      0001E7 C3               [12]  602 	clr	c
      0001E8 9D               [12]  603 	subb	a,r5
      0001E9 FD               [12]  604 	mov	r5,a
                                    605 ;	lib/src/delay.c:20: TH0TMP = HIBYTE(65535 - (16 * configdelay));
      0001EA AB 12            [24]  606 	mov	r3,_DelayT0_PARM_2
      0001EC E5 13            [12]  607 	mov	a,(_DelayT0_PARM_2 + 1)
      0001EE C4               [12]  608 	swap	a
      0001EF 54 F0            [12]  609 	anl	a,#0xf0
      0001F1 CB               [12]  610 	xch	a,r3
      0001F2 C4               [12]  611 	swap	a
      0001F3 CB               [12]  612 	xch	a,r3
      0001F4 6B               [12]  613 	xrl	a,r3
      0001F5 CB               [12]  614 	xch	a,r3
      0001F6 54 F0            [12]  615 	anl	a,#0xf0
      0001F8 CB               [12]  616 	xch	a,r3
      0001F9 6B               [12]  617 	xrl	a,r3
      0001FA FC               [12]  618 	mov	r4,a
      0001FB 8B 01            [24]  619 	mov	ar1,r3
      0001FD 8C 02            [24]  620 	mov	ar2,r4
      0001FF E4               [12]  621 	clr	a
      000200 FB               [12]  622 	mov	r3,a
      000201 FC               [12]  623 	mov	r4,a
      000202 74 FF            [12]  624 	mov	a,#0xff
      000204 C3               [12]  625 	clr	c
      000205 99               [12]  626 	subb	a,r1
      000206 74 FF            [12]  627 	mov	a,#0xff
      000208 9A               [12]  628 	subb	a,r2
      000209 FA               [12]  629 	mov	r2,a
      00020A E4               [12]  630 	clr	a
      00020B 9B               [12]  631 	subb	a,r3
      00020C E4               [12]  632 	clr	a
      00020D 9C               [12]  633 	subb	a,r4
      00020E 8A 04            [24]  634 	mov	ar4,r2
                                    635 ;	lib/src/delay.c:21: while (u16Count)
      000210                        636 00104$:
      000210 EE               [12]  637 	mov	a,r6
      000211 4F               [12]  638 	orl	a,r7
      000212 60 14            [24]  639 	jz	00107$
                                    640 ;	lib/src/delay.c:23: TL0 = TL0TMP;
      000214 8D 8A            [24]  641 	mov	_TL0,r5
                                    642 ;	lib/src/delay.c:24: TH0 = TH0TMP;
      000216 8C 8C            [24]  643 	mov	_TH0,r4
                                    644 ;	lib/src/delay.c:25: set_TCON_TR0; // Start Timer0
                                    645 ;	assignBit
      000218 D2 8C            [12]  646 	setb	_TR0
                                    647 ;	lib/src/delay.c:26: while (!TF0); // Check Timer0 Time-Out Flag
      00021A                        648 00101$:
                                    649 ;	lib/src/delay.c:27: clr_TCON_TF0;
                                    650 ;	assignBit
      00021A 10 8D 02         [24]  651 	jbc	_TF0,00127$
      00021D 80 FB            [24]  652 	sjmp	00101$
      00021F                        653 00127$:
                                    654 ;	lib/src/delay.c:28: clr_TCON_TR0; // Stop Timer0
                                    655 ;	assignBit
      00021F C2 8C            [12]  656 	clr	_TR0
                                    657 ;	lib/src/delay.c:29: --u16Count;
      000221 1E               [12]  658 	dec	r6
      000222 BE FF 01         [24]  659 	cjne	r6,#0xff,00128$
      000225 1F               [12]  660 	dec	r7
      000226                        661 00128$:
      000226 80 E8            [24]  662 	sjmp	00104$
      000228                        663 00107$:
                                    664 ;	lib/src/delay.c:31: }
      000228 22               [24]  665 	ret
                                    666 	.area CSEG    (CODE)
                                    667 	.area CONST   (CODE)
                                    668 	.area XINIT   (CODE)
