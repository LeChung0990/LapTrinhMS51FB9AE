      ...
      000000                        498 	.ds 8
                                    ...
                                    501 ;--------------------------------------------------------
                                    502 	.area DSEG    (DATA)
      00001D                        503 _UART0_NUMBER_digit_65536_31:
      00001D                        504 	.ds 5
                                    505 ;--------------------------------------------------------
      ...
      000119 43 C4 20         [24]  583 	orl	_T3CON,#0x20
                                    584 ;	lib/src/uart0.c:10: T3CON &= 0xF8;
      00011C 53 C4 F8         [24]  585 	anl	_T3CON,#0xf8
                                    586 ;	lib/src/uart0.c:13: EIE1 &= ~(1 << 1);
      00011F 53 9C FD         [24]  587 	anl	_EIE1,#0xfd
                                    588 ;	lib/src/uart0.c:15: RH3 = 0xff;
      000122 75 C6 FF         [24]  589 	mov	_RH3,#0xff
                                    590 ;	lib/src/uart0.c:16: RL3 = 0xe6;
      000125 75 C5 E6         [24]  591 	mov	_RL3,#0xe6
                                    592 ;	lib/src/uart0.c:18: T3CON |= (1 << 3);
      000128 43 C4 08         [24]  593 	orl	_T3CON,#0x08
                                    594 ;	lib/src/uart0.c:20: PCON &= ~(1 << 7);
      00012B 53 87 7F         [24]  595 	anl	_PCON,#0x7f
                                    596 ;	lib/src/uart0.c:22: P06 = 1;
                                    597 ;	assignBit
      00012E D2 86            [12]  598 	setb	_P06
                                    599 ;	lib/src/uart0.c:23: P0M1 &= ~(1 << 6);
      000130 53 B1 BF         [24]  600 	anl	_P0M1,#0xbf
                                    601 ;	lib/src/uart0.c:24: P0M2 |= (1 << 6);
      000133 43 B2 40         [24]  602 	orl	_P0M2,#0x40
                                    603 ;	lib/src/uart0.c:25: P07 = 1;
                                    604 ;	assignBit
      000136 D2 87            [12]  605 	setb	_P07
                                    606 ;	lib/src/uart0.c:26: P0M1 &= ~(1 << 7);
      000138 53 B1 7F         [24]  607 	anl	_P0M1,#0x7f
                                    608 ;	lib/src/uart0.c:27: P0M2 &= ~(1 << 7);
      00013B 53 B2 7F         [24]  609 	anl	_P0M2,#0x7f
                                    610 ;	lib/src/uart0.c:29: PCON &= ~(1 << 6);
      00013E 53 87 BF         [24]  611 	anl	_PCON,#0xbf
                                    612 ;	lib/src/uart0.c:30: SM0 = 0;
                                    613 ;	assignBit
      000141 C2 9F            [12]  614 	clr	_SM0
                                    615 ;	lib/src/uart0.c:31: SM1 = 1;
                                    616 ;	assignBit
      000143 D2 9E            [12]  617 	setb	_SM1
                                    618 ;	lib/src/uart0.c:33: REN = 1;
                                    619 ;	assignBit
      000145 D2 9C            [12]  620 	setb	_REN
                                    621 ;	lib/src/uart0.c:34: }
      000147 22               [24]  622 	ret
                                    623 ;------------------------------------------------------------
                                    ...
                                    631 ;	-----------------------------------------
      000148                        632 _UART0_SendData:
      000148 85 82 99         [24]  633 	mov	_SBUF,dpl
                                    634 ;	lib/src/uart0.c:38: SBUF = u8Data;
                                    635 ;	lib/src/uart0.c:39: }
      00014B 22               [24]  636 	ret
                                    637 ;------------------------------------------------------------
                                    ...
                                    643 ;	-----------------------------------------
      00014C                        644 _UART0_GetData:
                                    645 ;	lib/src/uart0.c:43: return SBUF;
      00014C 85 99 82         [24]  646 	mov	dpl,_SBUF
                                    647 ;	lib/src/uart0.c:44: }
      00014F 22               [24]  648 	ret
                                    649 ;------------------------------------------------------------
                                    ...
                                    655 ;	-----------------------------------------
      000150                        656 _UART0_EnableInterrupt:
                                    657 ;	lib/src/uart0.c:48: ES = 1;
                                    658 ;	assignBit
      000150 D2 AC            [12]  659 	setb	_ES
                                    660 ;	lib/src/uart0.c:49: }
      000152 22               [24]  661 	ret
                                    662 ;------------------------------------------------------------
                                    ...
                                    668 ;	-----------------------------------------
      000153                        669 _UART0_DisableInterrupt:
                                    670 ;	lib/src/uart0.c:53: ES = 0;
                                    671 ;	assignBit
      000153 C2 AC            [12]  672 	clr	_ES
                                    673 ;	lib/src/uart0.c:54: }
      000155 22               [24]  674 	ret
                                    675 ;------------------------------------------------------------
                                    ...
                                    683 ;	-----------------------------------------
      000156                        684 _UART0_ClearFlag:
                                    685 ;	lib/src/uart0.c:58: SCON &= ~(u8Flag);
      000156 E5 82            [12]  686 	mov	a,dpl
      000158 F4               [12]  687 	cpl	a
      000159 52 98            [12]  688 	anl	_SCON,a
                                    689 ;	lib/src/uart0.c:59: }
      00015B 22               [24]  690 	ret
                                    691 ;------------------------------------------------------------
                                    ...
                                    699 ;	-----------------------------------------
      00015C                        700 _UART0_GetFlag:
                                    701 ;	lib/src/uart0.c:63: if (SCON & (u8Flag)) {
      00015C E5 82            [12]  702 	mov	a,dpl
      00015E 55 98            [12]  703 	anl	a,_SCON
      000160 60 04            [24]  704 	jz	00102$
                                    705 ;	lib/src/uart0.c:64: return 1;
      000162 75 82 01         [24]  706 	mov	dpl,#0x01
      000165 22               [24]  707 	ret
      000166                        708 00102$:
                                    709 ;	lib/src/uart0.c:66: return 0;
      000166 75 82 00         [24]  710 	mov	dpl,#0x00
                                    711 ;	lib/src/uart0.c:68: }
      000169 22               [24]  712 	ret
                                    713 ;------------------------------------------------------------
                                    ...
                                    721 ;	-----------------------------------------
      00016A                        722 _UART0_STRING:
      00016A AD 82            [24]  723 	mov	r5,dpl
      00016C AE 83            [24]  724 	mov	r6,dph
      00016E AF F0            [24]  725 	mov	r7,b
                                    726 ;	lib/src/uart0.c:71: while(*cy)
      000170                        727 00104$:
      000170 8D 82            [24]  728 	mov	dpl,r5
      000172 8E 83            [24]  729 	mov	dph,r6
      000174 8F F0            [24]  730 	mov	b,r7
      000176 12 02 AC         [24]  731 	lcall	__gptrget
      000179 FC               [12]  732 	mov	r4,a
      00017A 60 31            [24]  733 	jz	00107$
                                    734 ;	lib/src/uart0.c:73: SBUF = (*cy);
      00017C 8C 99            [24]  735 	mov	_SBUF,r4
                                    736 ;	lib/src/uart0.c:74: while (UART0_GetFlag(UART0_TX_FLAG) == 0) {}
      00017E                        737 00101$:
      00017E 75 82 02         [24]  738 	mov	dpl,#0x02
      000181 C0 07            [24]  739 	push	ar7
      000183 C0 06            [24]  740 	push	ar6
      000185 C0 05            [24]  741 	push	ar5
      000187 12 01 5C         [24]  742 	lcall	_UART0_GetFlag
      00018A E5 82            [12]  743 	mov	a,dpl
      00018C D0 05            [24]  744 	pop	ar5
      00018E D0 06            [24]  745 	pop	ar6
      000190 D0 07            [24]  746 	pop	ar7
      000192 60 EA            [24]  747 	jz	00101$
                                    748 ;	lib/src/uart0.c:75: UART0_ClearFlag(UART0_TX_FLAG);
      000194 75 82 02         [24]  749 	mov	dpl,#0x02
      000197 C0 07            [24]  750 	push	ar7
      000199 C0 06            [24]  751 	push	ar6
      00019B C0 05            [24]  752 	push	ar5
      00019D 12 01 56         [24]  753 	lcall	_UART0_ClearFlag
      0001A0 D0 05            [24]  754 	pop	ar5
      0001A2 D0 06            [24]  755 	pop	ar6
      0001A4 D0 07            [24]  756 	pop	ar7
                                    757 ;	lib/src/uart0.c:76: cy++;
      0001A6 0D               [12]  758 	inc	r5
      0001A7 BD 00 C6         [24]  759 	cjne	r5,#0x00,00104$
      0001AA 0E               [12]  760 	inc	r6
      0001AB 80 C3            [24]  761 	sjmp	00104$
      0001AD                        762 00107$:
                                    763 ;	lib/src/uart0.c:78: }
      0001AD 22               [24]  764 	ret
                                    765 ;------------------------------------------------------------
                                    ...
                                    775 ;	-----------------------------------------
      0001AE                        776 _UART0_NUMBER:
      0001AE AE 82            [24]  777 	mov	r6,dpl
      0001B0 AF 83            [24]  778 	mov	r7,dph
                                    779 ;	lib/src/uart0.c:81: char count = 0;
      0001B2 7D 00            [12]  780 	mov	r5,#0x00
                                    781 ;	lib/src/uart0.c:82: char digit[5] = "";
      0001B4 8D 1D            [24]  782 	mov	_UART0_NUMBER_digit_65536_31,r5
      0001B6 8D 1E            [24]  783 	mov	(_UART0_NUMBER_digit_65536_31 + 0x0001),r5
      0001B8 8D 1F            [24]  784 	mov	(_UART0_NUMBER_digit_65536_31 + 0x0002),r5
      0001BA 8D 20            [24]  785 	mov	(_UART0_NUMBER_digit_65536_31 + 0x0003),r5
      0001BC 8D 21            [24]  786 	mov	(_UART0_NUMBER_digit_65536_31 + 0x0004),r5
                                    787 ;	lib/src/uart0.c:83: if (number == 0)
      0001BE EE               [12]  788 	mov	a,r6
      0001BF 4F               [12]  789 	orl	a,r7
                                    790 ;	lib/src/uart0.c:85: digit[0] = 0;
      0001C0 70 04            [24]  791 	jnz	00116$
      0001C2 F5 1D            [12]  792 	mov	_UART0_NUMBER_digit_65536_31,a
                                    793 ;	lib/src/uart0.c:86: count = 1;
      0001C4 7D 01            [12]  794 	mov	r5,#0x01
                                    795 ;	lib/src/uart0.c:88: while(number != 0)
      0001C6                        796 00116$:
      0001C6                        797 00103$:
      0001C6 EE               [12]  798 	mov	a,r6
      0001C7 4F               [12]  799 	orl	a,r7
      0001C8 60 3D            [24]  800 	jz	00120$
                                    801 ;	lib/src/uart0.c:90: digit[count] = number%10;   //lay chu so ngoai cung xxxx8;
      0001CA ED               [12]  802 	mov	a,r5
      0001CB 24 1D            [12]  803 	add	a,#_UART0_NUMBER_digit_65536_31
      0001CD F9               [12]  804 	mov	r1,a
      0001CE 75 22 0A         [24]  805 	mov	__modsint_PARM_2,#0x0a
      0001D1 75 23 00         [24]  806 	mov	(__modsint_PARM_2 + 1),#0x00
      0001D4 8E 82            [24]  807 	mov	dpl,r6
      0001D6 8F 83            [24]  808 	mov	dph,r7
      0001D8 C0 07            [24]  809 	push	ar7
      0001DA C0 06            [24]  810 	push	ar6
      0001DC C0 05            [24]  811 	push	ar5
      0001DE C0 01            [24]  812 	push	ar1
      0001E0 12 02 C8         [24]  813 	lcall	__modsint
      0001E3 AB 82            [24]  814 	mov	r3,dpl
      0001E5 D0 01            [24]  815 	pop	ar1
      0001E7 D0 05            [24]  816 	pop	ar5
      0001E9 D0 06            [24]  817 	pop	ar6
      0001EB D0 07            [24]  818 	pop	ar7
      0001ED A7 03            [24]  819 	mov	@r1,ar3
                                    820 ;	lib/src/uart0.c:91: ++count;
      0001EF 0D               [12]  821 	inc	r5
                                    822 ;	lib/src/uart0.c:92: number = number/10;         //chia so number cho 10 de bo so ngoai cung xxxx
      0001F0 75 22 0A         [24]  823 	mov	__divsint_PARM_2,#0x0a
      0001F3 75 23 00         [24]  824 	mov	(__divsint_PARM_2 + 1),#0x00
      0001F6 8E 82            [24]  825 	mov	dpl,r6
      0001F8 8F 83            [24]  826 	mov	dph,r7
      0001FA C0 05            [24]  827 	push	ar5
      0001FC 12 02 FE         [24]  828 	lcall	__divsint
      0001FF AE 82            [24]  829 	mov	r6,dpl
      000201 AF 83            [24]  830 	mov	r7,dph
      000203 D0 05            [24]  831 	pop	ar5
                                    832 ;	lib/src/uart0.c:94: while (count!=0)
      000205 80 BF            [24]  833 	sjmp	00103$
      000207                        834 00120$:
      000207 8D 07            [24]  835 	mov	ar7,r5
      000209                        836 00109$:
      000209 EF               [12]  837 	mov	a,r7
      00020A 60 29            [24]  838 	jz	00112$
                                    839 ;	lib/src/uart0.c:96: SBUF = (digit[count - 1] + 0x30); // 0x30 = 48 ;
      00020C 8F 06            [24]  840 	mov	ar6,r7
      00020E EE               [12]  841 	mov	a,r6
      00020F 14               [12]  842 	dec	a
      000210 24 1D            [12]  843 	add	a,#_UART0_NUMBER_digit_65536_31
      000212 F9               [12]  844 	mov	r1,a
      000213 87 06            [24]  845 	mov	ar6,@r1
      000215 74 30            [12]  846 	mov	a,#0x30
      000217 2E               [12]  847 	add	a,r6
      000218 F5 99            [12]  848 	mov	_SBUF,a
                                    849 ;	lib/src/uart0.c:97: while (UART0_GetFlag(UART0_TX_FLAG) == 0) {}
      00021A                        850 00106$:
      00021A 75 82 02         [24]  851 	mov	dpl,#0x02
      00021D C0 07            [24]  852 	push	ar7
      00021F 12 01 5C         [24]  853 	lcall	_UART0_GetFlag
      000222 E5 82            [12]  854 	mov	a,dpl
      000224 D0 07            [24]  855 	pop	ar7
      000226 60 F2            [24]  856 	jz	00106$
                                    857 ;	lib/src/uart0.c:98: UART0_ClearFlag(UART0_TX_FLAG);
      000228 75 82 02         [24]  858 	mov	dpl,#0x02
      00022B C0 07            [24]  859 	push	ar7
      00022D 12 01 56         [24]  860 	lcall	_UART0_ClearFlag
      000230 D0 07            [24]  861 	pop	ar7
                                    862 ;	lib/src/uart0.c:99: --count;
      000232 1F               [12]  863 	dec	r7
      000233 80 D4            [24]  864 	sjmp	00109$
      000235                        865 00112$:
                                    866 ;	lib/src/uart0.c:101: }
      000235 22               [24]  867 	ret
                                    868 	.area CSEG    (CODE)
                                    869 	.area CONST   (CODE)
                                    870 	.area XINIT   (CODE)
