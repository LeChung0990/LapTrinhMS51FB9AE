      ...
      000062                        586 _main:
                           ...
                           000001   593 	ar1 = 0x01
                           000000   594 	ar0 = 0x00
                                    595 ;	main.c:9: P15_PUSHPULL_MODE;
      000062 53 B3 DF         [24]  596 	anl	_P1M1,#0xdf
      000065 43 B4 20         [24]  597 	orl	_P1M2,#0x20
                                    598 ;	main.c:10: DelayT0_Init();
      000068 12 00 89         [24]  599 	lcall	_DelayT0_Init
                                    600 ;	main.c:11: while (1)
      00006B                        601 00102$:
                                    602 ;	main.c:13: P15 = 1;
                                    603 ;	assignBit
      00006B D2 95            [12]  604 	setb	_P15
                                    605 ;	main.c:14: DelayT0(500,CONFIG_1MS);
      00006D 75 08 E8         [24]  606 	mov	_DelayT0_PARM_2,#0xe8
      000070 75 09 03         [24]  607 	mov	(_DelayT0_PARM_2 + 1),#0x03
      000073 90 01 F4         [24]  608 	mov	dptr,#0x01f4
      000076 12 00 99         [24]  609 	lcall	_DelayT0
                                    610 ;	main.c:15: P15 = 0;
                                    611 ;	assignBit
      000079 C2 95            [12]  612 	clr	_P15
                                    613 ;	main.c:16: DelayT0(500,CONFIG_1MS);
      00007B 75 08 E8         [24]  614 	mov	_DelayT0_PARM_2,#0xe8
      00007E 75 09 03         [24]  615 	mov	(_DelayT0_PARM_2 + 1),#0x03
      000081 90 01 F4         [24]  616 	mov	dptr,#0x01f4
      000084 12 00 99         [24]  617 	lcall	_DelayT0
                                    618 ;	main.c:18: }
      000087 80 E2            [24]  619 	sjmp	00102$
                                    620 	.area CSEG    (CODE)
                                    621 	.area CONST   (CODE)
                                    622 	.area XINIT   (CODE)
