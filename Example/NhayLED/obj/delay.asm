...
;------------------------------------------------------------
;	lib/src/delay.c:18: void DelayT0(uint16_t u16Count, CONFIG configdelay)
;	-----------------------------------------
;	 function DelayT0
;	-----------------------------------------
_DelayT0:
	mov	r6,dpl
	mov	r7,dph
;	lib/src/delay.c:21: TL0TMP = LOBYTE(65535 - (16 * configdelay));
	...
	subb	a,r5
	mov	r5,a
;	lib/src/delay.c:22: TH0TMP = HIBYTE(65535 - (16 * configdelay));
	...
	subb	a,r4
	mov	ar4,r2
;	lib/src/delay.c:23: while (u16Count)
00104$:
	mov	a,r6
	orl	a,r7
	jz	00107$
;	lib/src/delay.c:25: TL0 = TL0TMP;
	mov	_TL0,r5
;	lib/src/delay.c:26: TH0 = TH0TMP;
	mov	_TH0,r4
;	lib/src/delay.c:27: set_TCON_TR0; // Start Timer0
;	assignBit
	setb	_TR0
;	lib/src/delay.c:28: while (!TF0); // Check Timer0 Time-Out Flag
00101$:
;	lib/src/delay.c:29: clr_TCON_TF0;
;	assignBit
	jbc	_TF0,00127$
	sjmp	00101$
00127$:
;	lib/src/delay.c:30: clr_TCON_TR0; // Stop Timer0
;	assignBit
	clr	_TR0
;	lib/src/delay.c:31: --u16Count;
	dec	r6
	cjne	r6,#0xff,00128$
	dec	r7
00128$:
