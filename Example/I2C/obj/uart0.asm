...
;	lib/src/uart0.c:82: char digit[5] = "";
	mov	_UART0_NUMBER_digit_65536_31,#0x00
	mov	(_UART0_NUMBER_digit_65536_31 + 0x0001),#0x00
	mov	(_UART0_NUMBER_digit_65536_31 + 0x0002),#0x00
	mov	(_UART0_NUMBER_digit_65536_31 + 0x0003),#0x00
	mov	(_UART0_NUMBER_digit_65536_31 + 0x0004),#0x00
;	lib/src/uart0.c:83: while(number != 0)
	mov	r5,#0x00
00101$:
	mov	a,r6
	orl	a,r7
	jz	00117$
;	lib/src/uart0.c:85: digit[count] = number%10;   //lay chu so ngoai cung xxxx8;
	mov	a,r5
	...
	pop	ar7
	mov	@r1,ar3
;	lib/src/uart0.c:86: ++count;
	inc	r5
;	lib/src/uart0.c:87: number = number/10;         //chia so number cho 10 de bo so ngoai cung xxxx
	...
	mov	r7,dph
	pop	ar5
;	lib/src/uart0.c:89: while (count!=0)
	sjmp	00101$
00117$:
	mov	ar7,r5
00107$:
	mov	a,r7
	jz	00110$
;	lib/src/uart0.c:91: SBUF = (digit[count - 1] + 0x30); // 0x30 = 48 ;
	mov	ar6,r7
	mov	a,r6
	dec	a
	add	a,#_UART0_NUMBER_digit_65536_31
	...
	add	a,r6
	mov	_SBUF,a
;	lib/src/uart0.c:92: while (UART0_GetFlag(UART0_TX_FLAG) == 0) {}
00104$:
	mov	dpl,#0x02
	push	ar7
	lcall	_UART0_GetFlag
	...
	pop	ar7
	jz	00104$
;	lib/src/uart0.c:93: UART0_ClearFlag(UART0_TX_FLAG);
	mov	dpl,#0x02
	push	ar7
	lcall	_UART0_ClearFlag
	pop	ar7
;	lib/src/uart0.c:94: --count;
	dec	r7
	sjmp	00107$
00110$:
;	lib/src/uart0.c:96: }
