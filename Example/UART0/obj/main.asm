...
;	main.c:13: while (1) {
00105$:
;	main.c:14: UART0_SendData(0x39);
	mov	dpl,#0x39
	lcall	_UART0_SendData
;	main.c:16: while (UART0_GetFlag(UART0_TX_FLAG) == 0) {
00101$:
	mov	dpl,#0x02
	lcall	_UART0_GetFlag
	mov	a,dpl
	jz	00101$
;	main.c:18: UART0_ClearFlag(UART0_TX_FLAG);
	mov	dpl,#0x02
	lcall	_UART0_ClearFlag
;	main.c:19: Delay_Ms(1000);
	mov	dptr,#0x03e8
	lcall	_Delay_Ms
;	main.c:21: }
	sjmp	00105$
...
;------------------------------------------------------------
;	main.c:22: void UART0_ISR(void) __interrupt (4){}
;	-----------------------------------------
;	 function UART0_ISR
;	-----------------------------------------
_UART0_ISR:
