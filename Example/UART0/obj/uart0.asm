...
;	lib/src/uart0.c:13: EIE1 &= ~(1 << 1);
	anl	_EIE1,#0xfd
;	lib/src/uart0.c:14: RH3 = 0xff;
	mov	_RH3,#0xff
;	lib/src/uart0.c:15: RL3 = 0xe6;
	mov	_RL3,#0xe6
;	lib/src/uart0.c:17: T3CON |= (1 << 3);
	orl	_T3CON,#0x08
;	lib/src/uart0.c:19: PCON &= ~(1 << 7);
	anl	_PCON,#0x7f
;	lib/src/uart0.c:21: P06 = 1;
;	assignBit
	setb	_P06
;	lib/src/uart0.c:22: P0M1 &= ~(1 << 6);
	anl	_P0M1,#0xbf
;	lib/src/uart0.c:23: P0M2 |= (1 << 6);
	orl	_P0M2,#0x40
;	lib/src/uart0.c:24: P07 = 1;
;	assignBit
	setb	_P07
;	lib/src/uart0.c:25: P0M1 &= ~(1 << 7);
	anl	_P0M1,#0x7f
;	lib/src/uart0.c:26: P0M2 &= ~(1 << 7);
	anl	_P0M2,#0x7f
;	lib/src/uart0.c:28: PCON &= ~(1 << 6);
	anl	_PCON,#0xbf
;	lib/src/uart0.c:29: SM0 = 0;
;	assignBit
	clr	_SM0
;	lib/src/uart0.c:30: SM1 = 1;
;	assignBit
	setb	_SM1
;	lib/src/uart0.c:32: REN = 1;
;	assignBit
	setb	_REN
;	lib/src/uart0.c:33: }
	ret
...
;------------------------------------------------------------
;	lib/src/uart0.c:35: void UART0_SendData(uint8_t u8Data)
;	-----------------------------------------
;	 function UART0_SendData
;	-----------------------------------------
_UART0_SendData:
	mov	_SBUF,dpl
;	lib/src/uart0.c:37: SBUF = u8Data;
;	lib/src/uart0.c:38: }
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'UART0_GetData'
;------------------------------------------------------------
;	lib/src/uart0.c:40: uint8_t UART0_GetData(void)
;	-----------------------------------------
;	 function UART0_GetData
;	-----------------------------------------
_UART0_GetData:
;	lib/src/uart0.c:42: return SBUF;
	mov	dpl,_SBUF
;	lib/src/uart0.c:43: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	lib/src/uart0.c:45: void UART0_EnableInterrupt(void)
;	-----------------------------------------
;	 function UART0_EnableInterrupt
;	-----------------------------------------
_UART0_EnableInterrupt:
;	lib/src/uart0.c:47: ES = 1;
;	assignBit
	setb	_ES
;	lib/src/uart0.c:48: }
	ret
...
;------------------------------------------------------------
;	lib/src/uart0.c:50: void UART0_DisableInterrupt(void)
;	-----------------------------------------
;	 function UART0_DisableInterrupt
;	-----------------------------------------
_UART0_DisableInterrupt:
;	lib/src/uart0.c:52: ES = 0;
;	assignBit
	clr	_ES
;	lib/src/uart0.c:53: }
	ret
...
;------------------------------------------------------------
;	lib/src/uart0.c:55: void UART0_ClearFlag(uint8_t u8Flag)
;	-----------------------------------------
;	 function UART0_ClearFlag
;	-----------------------------------------
_UART0_ClearFlag:
;	lib/src/uart0.c:57: SCON &= ~(u8Flag);
	mov	a,dpl
	cpl	a
	anl	_SCON,a
;	lib/src/uart0.c:58: }
...
;u8Flag                    Allocated to registers r7 
;------------------------------------------------------------
;	lib/src/uart0.c:60: uint8_t UART0_GetFlag(uint8_t u8Flag)
;	-----------------------------------------
;	 function UART0_GetFlag
;	-----------------------------------------
_UART0_GetFlag:
;	lib/src/uart0.c:62: if (SCON & (u8Flag)) {
	mov	a,dpl
	anl	a,_SCON
	jz	00102$
;	lib/src/uart0.c:63: return 1;
	mov	dpl,#0x01
	ret
00102$:
;	lib/src/uart0.c:65: return 0;
	mov	dpl,#0x00
;	lib/src/uart0.c:67: }
	ret
	.area CSEG    (CODE)
