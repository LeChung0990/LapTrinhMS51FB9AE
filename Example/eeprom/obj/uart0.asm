...
;------------------------------------------------------------
;	lib/src/uart0.c:79: void UART0_NLINE(void)
;	-----------------------------------------
;	 function UART0_NLINE
;	-----------------------------------------
_UART0_NLINE:
;	lib/src/uart0.c:81: SBUF = 0x0a;
	mov	_SBUF,#0x0a
;	lib/src/uart0.c:82: while (UART0_GetFlag(UART0_TX_FLAG) == 0) {}
00101$:
	mov	dpl,#0x02
	lcall	_UART0_GetFlag
	mov	a,dpl
	jz	00101$
;	lib/src/uart0.c:83: UART0_ClearFlag(UART0_TX_FLAG);
	mov	dpl,#0x02
;	lib/src/uart0.c:84: }
...
;------------------------------------------------------------
;	lib/src/uart0.c:85: void UART0_NUMBER(int number)
;	-----------------------------------------
...
_UART0_NUMBER:
	mov	r6,dpl
	mov	r7,dph
;	lib/src/uart0.c:87: char count = 0;
	mov	r5,#0x00
;	lib/src/uart0.c:88: char digit[5] = "";
...
;	lib/src/uart0.c:89: if (number == 0)
	mov	a,r6
	orl	a,r7
;	lib/src/uart0.c:91: digit[0] = 0;
	jnz	00116$
	mov	_UART0_NUMBER_digit_65536_35,a
;	lib/src/uart0.c:92: count = 1;
	mov	r5,#0x01
;	lib/src/uart0.c:94: while(number != 0)
00116$:
00103$:
	mov	a,r6
	orl	a,r7
	jz	00120$
;	lib/src/uart0.c:96: digit[count] = number%10;   //lay chu so ngoai cung xxxx8;
	mov	a,r5
	...
	pop	ar7
	mov	@r1,ar3
;	lib/src/uart0.c:97: ++count;
	inc	r5
;	lib/src/uart0.c:98: number = number/10;         //chia so number cho 10 de bo so ngoai cung xxxx
	...
	mov	r7,dph
	pop	ar5
;	lib/src/uart0.c:100: while (count!=0)
	sjmp	00103$
00120$:
	mov	ar7,r5
00109$:
	mov	a,r7
	jz	00112$
;	lib/src/uart0.c:102: SBUF = (digit[count - 1] + 0x30); // 0x30 = 48 ;
	mov	ar6,r7
	mov	a,r6
	dec	a
	add	a,#_UART0_NUMBER_digit_65536_35
	...
	add	a,r6
	mov	_SBUF,a
;	lib/src/uart0.c:103: while (UART0_GetFlag(UART0_TX_FLAG) == 0) {}
00106$:
	mov	dpl,#0x02
	push	ar7
	lcall	_UART0_GetFlag
	...
	pop	ar7
	jz	00106$
;	lib/src/uart0.c:104: UART0_ClearFlag(UART0_TX_FLAG);
	mov	dpl,#0x02
	push	ar7
	lcall	_UART0_ClearFlag
	pop	ar7
;	lib/src/uart0.c:105: --count;
	dec	r7
	sjmp	00109$
00112$:
;	lib/src/uart0.c:107: }
