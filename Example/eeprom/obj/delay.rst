      ...
      0001B6 43 8E 08         [24]  575 	orl	_CKCON,#0x08
                                    576 ;	lib/src/delay.c:7: ENABLE_TIMER0_MODE1; // Timer0 is 16-bit mode
      0001B9 53 89 F0         [24]  577 	anl	_TMOD,#0xf0
      0001BC 43 89 01         [24]  578 	orl	_TMOD,#0x01
                                    579 ;	lib/src/delay.c:8: }
      0001BF 22               [24]  580 	ret
                                    581 ;------------------------------------------------------------
                                    ...
                                    592 ;	-----------------------------------------
      0001C0                        593 _DelayT0:
      0001C0 AE 82            [24]  594 	mov	r6,dpl
      0001C2 AF 83            [24]  595 	mov	r7,dph
                                    596 ;	lib/src/delay.c:19: TL0TMP = LOBYTE(65535 - (16 * configdelay));
      0001C4 E5 0D            [12]  597 	mov	a,_DelayT0_PARM_2
      0001C6 C4               [12]  598 	swap	a
      0001C7 54 F0            [12]  599 	anl	a,#0xf0
      0001C9 FD               [12]  600 	mov	r5,a
      0001CA 74 FF            [12]  601 	mov	a,#0xff
      0001CC C3               [12]  602 	clr	c
      0001CD 9D               [12]  603 	subb	a,r5
      0001CE FD               [12]  604 	mov	r5,a
                                    605 ;	lib/src/delay.c:20: TH0TMP = HIBYTE(65535 - (16 * configdelay));
      0001CF AB 0D            [24]  606 	mov	r3,_DelayT0_PARM_2
      0001D1 E5 0E            [12]  607 	mov	a,(_DelayT0_PARM_2 + 1)
      0001D3 C4               [12]  608 	swap	a
      0001D4 54 F0            [12]  609 	anl	a,#0xf0
      0001D6 CB               [12]  610 	xch	a,r3
      0001D7 C4               [12]  611 	swap	a
      0001D8 CB               [12]  612 	xch	a,r3
      0001D9 6B               [12]  613 	xrl	a,r3
      0001DA CB               [12]  614 	xch	a,r3
      0001DB 54 F0            [12]  615 	anl	a,#0xf0
      0001DD CB               [12]  616 	xch	a,r3
      0001DE 6B               [12]  617 	xrl	a,r3
      0001DF FC               [12]  618 	mov	r4,a
      0001E0 8B 01            [24]  619 	mov	ar1,r3
      0001E2 8C 02            [24]  620 	mov	ar2,r4
      0001E4 E4               [12]  621 	clr	a
      0001E5 FB               [12]  622 	mov	r3,a
      0001E6 FC               [12]  623 	mov	r4,a
      0001E7 74 FF            [12]  624 	mov	a,#0xff
      0001E9 C3               [12]  625 	clr	c
      0001EA 99               [12]  626 	subb	a,r1
      0001EB 74 FF            [12]  627 	mov	a,#0xff
      0001ED 9A               [12]  628 	subb	a,r2
      0001EE FA               [12]  629 	mov	r2,a
      0001EF E4               [12]  630 	clr	a
      0001F0 9B               [12]  631 	subb	a,r3
      0001F1 E4               [12]  632 	clr	a
      0001F2 9C               [12]  633 	subb	a,r4
      0001F3 8A 04            [24]  634 	mov	ar4,r2
                                    635 ;	lib/src/delay.c:21: while (u16Count)
      0001F5                        636 00104$:
      0001F5 EE               [12]  637 	mov	a,r6
      0001F6 4F               [12]  638 	orl	a,r7
      0001F7 60 14            [24]  639 	jz	00107$
                                    640 ;	lib/src/delay.c:23: TL0 = TL0TMP;
      0001F9 8D 8A            [24]  641 	mov	_TL0,r5
                                    642 ;	lib/src/delay.c:24: TH0 = TH0TMP;
      0001FB 8C 8C            [24]  643 	mov	_TH0,r4
                                    644 ;	lib/src/delay.c:25: set_TCON_TR0; // Start Timer0
                                    645 ;	assignBit
      0001FD D2 8C            [12]  646 	setb	_TR0
                                    647 ;	lib/src/delay.c:26: while (!TF0); // Check Timer0 Time-Out Flag
      0001FF                        648 00101$:
                                    649 ;	lib/src/delay.c:27: clr_TCON_TF0;
                                    650 ;	assignBit
      0001FF 10 8D 02         [24]  651 	jbc	_TF0,00127$
      000202 80 FB            [24]  652 	sjmp	00101$
      000204                        653 00127$:
                                    654 ;	lib/src/delay.c:28: clr_TCON_TR0; // Stop Timer0
                                    655 ;	assignBit
      000204 C2 8C            [12]  656 	clr	_TR0
                                    657 ;	lib/src/delay.c:29: --u16Count;
      000206 1E               [12]  658 	dec	r6
      000207 BE FF 01         [24]  659 	cjne	r6,#0xff,00128$
      00020A 1F               [12]  660 	dec	r7
      00020B                        661 00128$:
      00020B 80 E8            [24]  662 	sjmp	00104$
      00020D                        663 00107$:
                                    664 ;	lib/src/delay.c:31: }
      00020D 22               [24]  665 	ret
                                    666 	.area CSEG    (CODE)
                                    667 	.area CONST   (CODE)
                                    668 	.area XINIT   (CODE)
