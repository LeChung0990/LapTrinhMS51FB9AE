      ...
      000267 43 C4 20         [24]  584 	orl	_T3CON,#0x20
                                    585 ;	lib/src/uart0.c:10: T3CON &= 0xF8;
      00026A 53 C4 F8         [24]  586 	anl	_T3CON,#0xf8
                                    587 ;	lib/src/uart0.c:13: EIE1 &= ~(1 << 1);
      00026D 53 9C FD         [24]  588 	anl	_EIE1,#0xfd
                                    589 ;	lib/src/uart0.c:15: RH3 = 0xff;
      000270 75 C6 FF         [24]  590 	mov	_RH3,#0xff
                                    591 ;	lib/src/uart0.c:16: RL3 = 0xe6;
      000273 75 C5 E6         [24]  592 	mov	_RL3,#0xe6
                                    593 ;	lib/src/uart0.c:18: T3CON |= (1 << 3);
      000276 43 C4 08         [24]  594 	orl	_T3CON,#0x08
                                    595 ;	lib/src/uart0.c:20: PCON &= ~(1 << 7);
      000279 53 87 7F         [24]  596 	anl	_PCON,#0x7f
                                    597 ;	lib/src/uart0.c:22: P06 = 1;
                                    598 ;	assignBit
      00027C D2 86            [12]  599 	setb	_P06
                                    600 ;	lib/src/uart0.c:23: P0M1 &= ~(1 << 6);
      00027E 53 B1 BF         [24]  601 	anl	_P0M1,#0xbf
                                    602 ;	lib/src/uart0.c:24: P0M2 |= (1 << 6);
      000281 43 B2 40         [24]  603 	orl	_P0M2,#0x40
                                    604 ;	lib/src/uart0.c:25: P07 = 1;
                                    605 ;	assignBit
      000284 D2 87            [12]  606 	setb	_P07
                                    607 ;	lib/src/uart0.c:26: P0M1 &= ~(1 << 7);
      000286 53 B1 7F         [24]  608 	anl	_P0M1,#0x7f
                                    609 ;	lib/src/uart0.c:27: P0M2 &= ~(1 << 7);
      000289 53 B2 7F         [24]  610 	anl	_P0M2,#0x7f
                                    611 ;	lib/src/uart0.c:29: PCON &= ~(1 << 6);
      00028C 53 87 BF         [24]  612 	anl	_PCON,#0xbf
                                    613 ;	lib/src/uart0.c:30: SM0 = 0;
                                    614 ;	assignBit
      00028F C2 9F            [12]  615 	clr	_SM0
                                    616 ;	lib/src/uart0.c:31: SM1 = 1;
                                    617 ;	assignBit
      000291 D2 9E            [12]  618 	setb	_SM1
                                    619 ;	lib/src/uart0.c:33: REN = 1;
                                    620 ;	assignBit
      000293 D2 9C            [12]  621 	setb	_REN
                                    622 ;	lib/src/uart0.c:34: }
      000295 22               [24]  623 	ret
                                    624 ;------------------------------------------------------------
                                    ...
                                    632 ;	-----------------------------------------
      000296                        633 _UART0_SendData:
      000296 85 82 99         [24]  634 	mov	_SBUF,dpl
                                    635 ;	lib/src/uart0.c:38: SBUF = u8Data;
                                    636 ;	lib/src/uart0.c:39: }
      000299 22               [24]  637 	ret
                                    638 ;------------------------------------------------------------
                                    ...
                                    644 ;	-----------------------------------------
      00029A                        645 _UART0_GetData:
                                    646 ;	lib/src/uart0.c:43: return SBUF;
      00029A 85 99 82         [24]  647 	mov	dpl,_SBUF
                                    648 ;	lib/src/uart0.c:44: }
      00029D 22               [24]  649 	ret
                                    650 ;------------------------------------------------------------
                                    ...
                                    656 ;	-----------------------------------------
      00029E                        657 _UART0_EnableInterrupt:
                                    658 ;	lib/src/uart0.c:48: ES = 1;
                                    659 ;	assignBit
      00029E D2 AC            [12]  660 	setb	_ES
                                    661 ;	lib/src/uart0.c:49: }
      0002A0 22               [24]  662 	ret
                                    663 ;------------------------------------------------------------
                                    ...
                                    669 ;	-----------------------------------------
      0002A1                        670 _UART0_DisableInterrupt:
                                    671 ;	lib/src/uart0.c:53: ES = 0;
                                    672 ;	assignBit
      0002A1 C2 AC            [12]  673 	clr	_ES
                                    674 ;	lib/src/uart0.c:54: }
      0002A3 22               [24]  675 	ret
                                    676 ;------------------------------------------------------------
                                    ...
                                    684 ;	-----------------------------------------
      0002A4                        685 _UART0_ClearFlag:
                                    686 ;	lib/src/uart0.c:58: SCON &= ~(u8Flag);
      0002A4 E5 82            [12]  687 	mov	a,dpl
      0002A6 F4               [12]  688 	cpl	a
      0002A7 52 98            [12]  689 	anl	_SCON,a
                                    690 ;	lib/src/uart0.c:59: }
      0002A9 22               [24]  691 	ret
                                    692 ;------------------------------------------------------------
                                    ...
                                    700 ;	-----------------------------------------
      0002AA                        701 _UART0_GetFlag:
                                    702 ;	lib/src/uart0.c:63: if (SCON & (u8Flag)) {
      0002AA E5 82            [12]  703 	mov	a,dpl
      0002AC 55 98            [12]  704 	anl	a,_SCON
      0002AE 60 04            [24]  705 	jz	00102$
                                    706 ;	lib/src/uart0.c:64: return 1;
      0002B0 75 82 01         [24]  707 	mov	dpl,#0x01
      0002B3 22               [24]  708 	ret
      0002B4                        709 00102$:
                                    710 ;	lib/src/uart0.c:66: return 0;
      0002B4 75 82 00         [24]  711 	mov	dpl,#0x00
                                    712 ;	lib/src/uart0.c:68: }
      0002B7 22               [24]  713 	ret
                                    714 ;------------------------------------------------------------
                                    ...
                                    722 ;	-----------------------------------------
      0002B8                        723 _UART0_STRING:
      0002B8 AD 82            [24]  724 	mov	r5,dpl
      0002BA AE 83            [24]  725 	mov	r6,dph
      0002BC AF F0            [24]  726 	mov	r7,b
                                    727 ;	lib/src/uart0.c:71: while(*cy)
      0002BE                        728 00104$:
      0002BE 8D 82            [24]  729 	mov	dpl,r5
      0002C0 8E 83            [24]  730 	mov	dph,r6
      0002C2 8F F0            [24]  731 	mov	b,r7
      0002C4 12 04 0D         [24]  732 	lcall	__gptrget
      0002C7 FC               [12]  733 	mov	r4,a
      0002C8 60 31            [24]  734 	jz	00107$
                                    735 ;	lib/src/uart0.c:73: SBUF = (*cy);
      0002CA 8C 99            [24]  736 	mov	_SBUF,r4
                                    737 ;	lib/src/uart0.c:74: while (UART0_GetFlag(UART0_TX_FLAG) == 0) {}
      0002CC                        738 00101$:
      0002CC 75 82 02         [24]  739 	mov	dpl,#0x02
      0002CF C0 07            [24]  740 	push	ar7
      0002D1 C0 06            [24]  741 	push	ar6
      0002D3 C0 05            [24]  742 	push	ar5
      0002D5 12 02 AA         [24]  743 	lcall	_UART0_GetFlag
      0002D8 E5 82            [12]  744 	mov	a,dpl
      0002DA D0 05            [24]  745 	pop	ar5
      0002DC D0 06            [24]  746 	pop	ar6
      0002DE D0 07            [24]  747 	pop	ar7
      0002E0 60 EA            [24]  748 	jz	00101$
                                    749 ;	lib/src/uart0.c:75: UART0_ClearFlag(UART0_TX_FLAG);
      0002E2 75 82 02         [24]  750 	mov	dpl,#0x02
      0002E5 C0 07            [24]  751 	push	ar7
      0002E7 C0 06            [24]  752 	push	ar6
      0002E9 C0 05            [24]  753 	push	ar5
      0002EB 12 02 A4         [24]  754 	lcall	_UART0_ClearFlag
      0002EE D0 05            [24]  755 	pop	ar5
      0002F0 D0 06            [24]  756 	pop	ar6
      0002F2 D0 07            [24]  757 	pop	ar7
                                    758 ;	lib/src/uart0.c:76: cy++;
      0002F4 0D               [12]  759 	inc	r5
      0002F5 BD 00 C6         [24]  760 	cjne	r5,#0x00,00104$
      0002F8 0E               [12]  761 	inc	r6
      0002F9 80 C3            [24]  762 	sjmp	00104$
      0002FB                        763 00107$:
                                    764 ;	lib/src/uart0.c:78: }
      0002FB 22               [24]  765 	ret
                                    766 ;------------------------------------------------------------
                                    ...
                                    772 ;	-----------------------------------------
      0002FC                        773 _UART0_NLINE:
                                    774 ;	lib/src/uart0.c:81: SBUF = 0x0a;
      0002FC 75 99 0A         [24]  775 	mov	_SBUF,#0x0a
                                    776 ;	lib/src/uart0.c:82: while (UART0_GetFlag(UART0_TX_FLAG) == 0) {}
      0002FF                        777 00101$:
      0002FF 75 82 02         [24]  778 	mov	dpl,#0x02
      000302 12 02 AA         [24]  779 	lcall	_UART0_GetFlag
      000305 E5 82            [12]  780 	mov	a,dpl
      000307 60 F6            [24]  781 	jz	00101$
                                    782 ;	lib/src/uart0.c:83: UART0_ClearFlag(UART0_TX_FLAG);
      000309 75 82 02         [24]  783 	mov	dpl,#0x02
                                    784 ;	lib/src/uart0.c:84: }
      00030C 02 02 A4         [24]  785 	ljmp	_UART0_ClearFlag
                                    786 ;------------------------------------------------------------
                                    ...
                                    796 ;	-----------------------------------------
      00030F                        797 _UART0_NUMBER:
      00030F AE 82            [24]  798 	mov	r6,dpl
      000311 AF 83            [24]  799 	mov	r7,dph
                                    800 ;	lib/src/uart0.c:87: char count = 0;
      000313 7D 00            [12]  801 	mov	r5,#0x00
                                    802 ;	lib/src/uart0.c:88: char digit[5] = "";
      000315 8D 11            [24]  803 	mov	_UART0_NUMBER_digit_65536_35,r5
      000317 8D 12            [24]  804 	mov	(_UART0_NUMBER_digit_65536_35 + 0x0001),r5
      000319 8D 13            [24]  805 	mov	(_UART0_NUMBER_digit_65536_35 + 0x0002),r5
      00031B 8D 14            [24]  806 	mov	(_UART0_NUMBER_digit_65536_35 + 0x0003),r5
      00031D 8D 15            [24]  807 	mov	(_UART0_NUMBER_digit_65536_35 + 0x0004),r5
                                    808 ;	lib/src/uart0.c:89: if (number == 0)
      00031F EE               [12]  809 	mov	a,r6
      000320 4F               [12]  810 	orl	a,r7
                                    811 ;	lib/src/uart0.c:91: digit[0] = 0;
      000321 70 04            [24]  812 	jnz	00116$
      000323 F5 11            [12]  813 	mov	_UART0_NUMBER_digit_65536_35,a
                                    814 ;	lib/src/uart0.c:92: count = 1;
      000325 7D 01            [12]  815 	mov	r5,#0x01
                                    816 ;	lib/src/uart0.c:94: while(number != 0)
      000327                        817 00116$:
      000327                        818 00103$:
      000327 EE               [12]  819 	mov	a,r6
      000328 4F               [12]  820 	orl	a,r7
      000329 60 3D            [24]  821 	jz	00120$
                                    822 ;	lib/src/uart0.c:96: digit[count] = number%10;   //lay chu so ngoai cung xxxx8;
      00032B ED               [12]  823 	mov	a,r5
      00032C 24 11            [12]  824 	add	a,#_UART0_NUMBER_digit_65536_35
      00032E F9               [12]  825 	mov	r1,a
      00032F 75 16 0A         [24]  826 	mov	__modsint_PARM_2,#0x0a
      000332 75 17 00         [24]  827 	mov	(__modsint_PARM_2 + 1),#0x00
      000335 8E 82            [24]  828 	mov	dpl,r6
      000337 8F 83            [24]  829 	mov	dph,r7
      000339 C0 07            [24]  830 	push	ar7
      00033B C0 06            [24]  831 	push	ar6
      00033D C0 05            [24]  832 	push	ar5
      00033F C0 01            [24]  833 	push	ar1
      000341 12 04 29         [24]  834 	lcall	__modsint
      000344 AB 82            [24]  835 	mov	r3,dpl
      000346 D0 01            [24]  836 	pop	ar1
      000348 D0 05            [24]  837 	pop	ar5
      00034A D0 06            [24]  838 	pop	ar6
      00034C D0 07            [24]  839 	pop	ar7
      00034E A7 03            [24]  840 	mov	@r1,ar3
                                    841 ;	lib/src/uart0.c:97: ++count;
      000350 0D               [12]  842 	inc	r5
                                    843 ;	lib/src/uart0.c:98: number = number/10;         //chia so number cho 10 de bo so ngoai cung xxxx
      000351 75 16 0A         [24]  844 	mov	__divsint_PARM_2,#0x0a
      000354 75 17 00         [24]  845 	mov	(__divsint_PARM_2 + 1),#0x00
      000357 8E 82            [24]  846 	mov	dpl,r6
      000359 8F 83            [24]  847 	mov	dph,r7
      00035B C0 05            [24]  848 	push	ar5
      00035D 12 04 5F         [24]  849 	lcall	__divsint
      000360 AE 82            [24]  850 	mov	r6,dpl
      000362 AF 83            [24]  851 	mov	r7,dph
      000364 D0 05            [24]  852 	pop	ar5
                                    853 ;	lib/src/uart0.c:100: while (count!=0)
      000366 80 BF            [24]  854 	sjmp	00103$
      000368                        855 00120$:
      000368 8D 07            [24]  856 	mov	ar7,r5
      00036A                        857 00109$:
      00036A EF               [12]  858 	mov	a,r7
      00036B 60 29            [24]  859 	jz	00112$
                                    860 ;	lib/src/uart0.c:102: SBUF = (digit[count - 1] + 0x30); // 0x30 = 48 ;
      00036D 8F 06            [24]  861 	mov	ar6,r7
      00036F EE               [12]  862 	mov	a,r6
      000370 14               [12]  863 	dec	a
      000371 24 11            [12]  864 	add	a,#_UART0_NUMBER_digit_65536_35
      000373 F9               [12]  865 	mov	r1,a
      000374 87 06            [24]  866 	mov	ar6,@r1
      000376 74 30            [12]  867 	mov	a,#0x30
      000378 2E               [12]  868 	add	a,r6
      000379 F5 99            [12]  869 	mov	_SBUF,a
                                    870 ;	lib/src/uart0.c:103: while (UART0_GetFlag(UART0_TX_FLAG) == 0) {}
      00037B                        871 00106$:
      00037B 75 82 02         [24]  872 	mov	dpl,#0x02
      00037E C0 07            [24]  873 	push	ar7
      000380 12 02 AA         [24]  874 	lcall	_UART0_GetFlag
      000383 E5 82            [12]  875 	mov	a,dpl
      000385 D0 07            [24]  876 	pop	ar7
      000387 60 F2            [24]  877 	jz	00106$
                                    878 ;	lib/src/uart0.c:104: UART0_ClearFlag(UART0_TX_FLAG);
      000389 75 82 02         [24]  879 	mov	dpl,#0x02
      00038C C0 07            [24]  880 	push	ar7
      00038E 12 02 A4         [24]  881 	lcall	_UART0_ClearFlag
      000391 D0 07            [24]  882 	pop	ar7
                                    883 ;	lib/src/uart0.c:105: --count;
      000393 1F               [12]  884 	dec	r7
      000394 80 D4            [24]  885 	sjmp	00109$
      000396                        886 00112$:
                                    887 ;	lib/src/uart0.c:107: }
      000396 22               [24]  888 	ret
                                    889 	.area CSEG    (CODE)
                                    890 	.area CONST   (CODE)
                                    891 	.area XINIT   (CODE)
