      ...
      000000 02 00 41         [24]  551 	ljmp	__sdcc_gsinit_startup
      000003 32               [24]  552 	reti
      000004                        553 	.ds	7
      00000B 32               [24]  554 	reti
      00000C                        555 	.ds	7
      000013 32               [24]  556 	reti
      000014                        557 	.ds	7
      00001B 32               [24]  558 	reti
      00001C                        559 	.ds	7
      000023 32               [24]  560 	reti
      000024                        561 	.ds	7
      00002B 32               [24]  562 	reti
      00002C                        563 	.ds	7
      000033 32               [24]  564 	reti
      000034                        565 	.ds	7
      00003B 02 00 BA         [24]  566 	ljmp	_Exti_ISR
                                    567 ;--------------------------------------------------------
      ...
      00009A 02 00 3E         [24]  581 	ljmp	__sdcc_program_startup
                                    582 ;--------------------------------------------------------
                                    583 ; Home
                                    584 ;--------------------------------------------------------
                                    585 	.area HOME    (CODE)
                                    586 	.area HOME    (CODE)
      00003E                        587 __sdcc_program_startup:
      00003E 02 00 A7         [24]  588 	ljmp	_main
                                    ...
                                    593 	.area CSEG    (CODE)
                                    594 ;------------------------------------------------------------
                                    595 ;Allocation info for local variables in function 'External_Int_Config'
                                    596 ;------------------------------------------------------------
                                    597 ;	main.c:8: void External_Int_Config(void)
                                    598 ;	-----------------------------------------
                                    599 ;	 function External_Int_Config
                                    600 ;	-----------------------------------------
      00009D                        601 _External_Int_Config:
                           000007   602 	ar7 = 0x07
                           000006   603 	ar6 = 0x06
                           000005   604 	ar5 = 0x05
                           000004   605 	ar4 = 0x04
                           ...
                           000001   608 	ar1 = 0x01
                           000000   609 	ar0 = 0x00
                                    610 ;	main.c:11: set_PICON_PIT1;	  /*Edge triggered.*/
      00009D 43 E9 08         [24]  611 	orl	_PICON,#0x08
                                    612 ;	main.c:12: set_PINEN_PINEN1; /*Low-level/falling edge detect Enabled*/
      0000A0 43 EA 02         [24]  613 	orl	_PINEN,#0x02
                                    614 ;	main.c:13: set_PICON_PIPS0;
      0000A3 43 E9 01         [24]  615 	orl	_PICON,#0x01
                                    616 ;	main.c:20: }
      0000A6 22               [24]  617 	ret
                                    618 ;------------------------------------------------------------
                                    619 ;Allocation info for local variables in function 'main'
                                    620 ;------------------------------------------------------------
                                    621 ;	main.c:22: void main(void)
                                    622 ;	-----------------------------------------
                                    623 ;	 function main
                                    624 ;	-----------------------------------------
      0000A7                        625 _main:
                                    626 ;	main.c:27: P15_PUSHPULL_MODE;
      0000A7 53 B3 DF         [24]  627 	anl	_P1M1,#0xdf
      0000AA 43 B4 20         [24]  628 	orl	_P1M2,#0x20
                                    629 ;	main.c:29: P15 = 0;
                                    630 ;	assignBit
      0000AD C2 95            [12]  631 	clr	_P15
                                    632 ;	main.c:30: External_Int_Config();
      0000AF 12 00 9D         [24]  633 	lcall	_External_Int_Config
                                    634 ;	main.c:31: P14_INPUT_MODE;
      0000B2 43 B3 10         [24]  635 	orl	_P1M1,#0x10
      0000B5 53 B4 EF         [24]  636 	anl	_P1M2,#0xef
                                    637 ;	main.c:32: while (1)
      0000B8                        638 00102$:
                                    639 ;	main.c:43: }
      0000B8 80 FE            [24]  640 	sjmp	00102$
                                    641 ;------------------------------------------------------------
                                    642 ;Allocation info for local variables in function 'Exti_ISR'
                                    643 ;------------------------------------------------------------
                                    644 ;	main.c:46: void Exti_ISR(void) __interrupt(7)
                                    645 ;	-----------------------------------------
                                    646 ;	 function Exti_ISR
                                    647 ;	-----------------------------------------
      0000BA                        648 _Exti_ISR:
                                    649 ;	main.c:48: PIF &= ~(1 << 1); /*clear Interrupt Flags*/
      0000BA 53 EC FD         [24]  650 	anl	_PIF,#0xfd
                                    651 ;	main.c:50: P15 = 1;			  
                                    652 ;	assignBit
      0000BD D2 95            [12]  653 	setb	_P15
                                    654 ;	main.c:51: }
      0000BF 32               [24]  655 	reti
