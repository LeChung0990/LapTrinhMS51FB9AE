      ...
      000178 43 8E 08         [24]  575 	orl	_CKCON,#0x08
                                    576 ;	lib/src/delay.c:7: ENABLE_TIMER0_MODE1; // Timer0 is 16-bit mode
      00017B 53 89 F0         [24]  577 	anl	_TMOD,#0xf0
      00017E 43 89 01         [24]  578 	orl	_TMOD,#0x01
                                    579 ;	lib/src/delay.c:8: }
      000181 22               [24]  580 	ret
                                    581 ;------------------------------------------------------------
                                    ...
                                    592 ;	-----------------------------------------
      000182                        593 _DelayT0:
      000182 AE 82            [24]  594 	mov	r6,dpl
      000184 AF 83            [24]  595 	mov	r7,dph
                                    596 ;	lib/src/delay.c:19: TL0TMP = LOBYTE(65535 - (16 * configdelay));
      000186 E5 10            [12]  597 	mov	a,_DelayT0_PARM_2
      000188 C4               [12]  598 	swap	a
      000189 54 F0            [12]  599 	anl	a,#0xf0
      00018B FD               [12]  600 	mov	r5,a
      00018C 74 FF            [12]  601 	mov	a,#0xff
      00018E C3               [12]  602 	clr	c
      00018F 9D               [12]  603 	subb	a,r5
      000190 FD               [12]  604 	mov	r5,a
                                    605 ;	lib/src/delay.c:20: TH0TMP = HIBYTE(65535 - (16 * configdelay));
      000191 AB 10            [24]  606 	mov	r3,_DelayT0_PARM_2
      000193 E5 11            [12]  607 	mov	a,(_DelayT0_PARM_2 + 1)
      000195 C4               [12]  608 	swap	a
      000196 54 F0            [12]  609 	anl	a,#0xf0
      000198 CB               [12]  610 	xch	a,r3
      000199 C4               [12]  611 	swap	a
      00019A CB               [12]  612 	xch	a,r3
      00019B 6B               [12]  613 	xrl	a,r3
      00019C CB               [12]  614 	xch	a,r3
      00019D 54 F0            [12]  615 	anl	a,#0xf0
      00019F CB               [12]  616 	xch	a,r3
      0001A0 6B               [12]  617 	xrl	a,r3
      0001A1 FC               [12]  618 	mov	r4,a
      0001A2 8B 01            [24]  619 	mov	ar1,r3
      0001A4 8C 02            [24]  620 	mov	ar2,r4
      0001A6 E4               [12]  621 	clr	a
      0001A7 FB               [12]  622 	mov	r3,a
      0001A8 FC               [12]  623 	mov	r4,a
      0001A9 74 FF            [12]  624 	mov	a,#0xff
      0001AB C3               [12]  625 	clr	c
      0001AC 99               [12]  626 	subb	a,r1
      0001AD 74 FF            [12]  627 	mov	a,#0xff
      0001AF 9A               [12]  628 	subb	a,r2
      0001B0 FA               [12]  629 	mov	r2,a
      0001B1 E4               [12]  630 	clr	a
      0001B2 9B               [12]  631 	subb	a,r3
      0001B3 E4               [12]  632 	clr	a
      0001B4 9C               [12]  633 	subb	a,r4
      0001B5 8A 04            [24]  634 	mov	ar4,r2
                                    635 ;	lib/src/delay.c:21: while (u16Count)
      0001B7                        636 00104$:
      0001B7 EE               [12]  637 	mov	a,r6
      0001B8 4F               [12]  638 	orl	a,r7
      0001B9 60 14            [24]  639 	jz	00107$
                                    640 ;	lib/src/delay.c:23: TL0 = TL0TMP;
      0001BB 8D 8A            [24]  641 	mov	_TL0,r5
                                    642 ;	lib/src/delay.c:24: TH0 = TH0TMP;
      0001BD 8C 8C            [24]  643 	mov	_TH0,r4
                                    644 ;	lib/src/delay.c:25: set_TCON_TR0; // Start Timer0
                                    645 ;	assignBit
      0001BF D2 8C            [12]  646 	setb	_TR0
                                    647 ;	lib/src/delay.c:26: while (!TF0); // Check Timer0 Time-Out Flag
      0001C1                        648 00101$:
                                    649 ;	lib/src/delay.c:27: clr_TCON_TF0;
                                    650 ;	assignBit
      0001C1 10 8D 02         [24]  651 	jbc	_TF0,00127$
      0001C4 80 FB            [24]  652 	sjmp	00101$
      0001C6                        653 00127$:
                                    654 ;	lib/src/delay.c:28: clr_TCON_TR0; // Stop Timer0
                                    655 ;	assignBit
      0001C6 C2 8C            [12]  656 	clr	_TR0
                                    657 ;	lib/src/delay.c:29: --u16Count;
      0001C8 1E               [12]  658 	dec	r6
      0001C9 BE FF 01         [24]  659 	cjne	r6,#0xff,00128$
      0001CC 1F               [12]  660 	dec	r7
      0001CD                        661 00128$:
      0001CD 80 E8            [24]  662 	sjmp	00104$
      0001CF                        663 00107$:
                                    664 ;	lib/src/delay.c:31: }
      0001CF 22               [24]  665 	ret
                                    666 	.area CSEG    (CODE)
                                    667 	.area CONST   (CODE)
                                    668 	.area XINIT   (CODE)
