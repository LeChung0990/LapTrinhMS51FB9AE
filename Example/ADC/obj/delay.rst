      ...
      00013D 43 89 01         [24]  571 	orl	_TMOD,#0x01
                                    572 ;	lib/src/delay.c:10: TMOD &= ~(1 << 1);
      000140 53 89 FD         [24]  573 	anl	_TMOD,#0xfd
                                    574 ;	lib/src/delay.c:11: CKCON |= (1 << 3);
      000143 43 8E 08         [24]  575 	orl	_CKCON,#0x08
                                    576 ;	lib/src/delay.c:12: TMOD &= ~(1 << 2);
      000146 53 89 FB         [24]  577 	anl	_TMOD,#0xfb
                                    578 ;	lib/src/delay.c:13: TMOD &= ~(1 << 3);
      000149 53 89 F7         [24]  579 	anl	_TMOD,#0xf7
                                    580 ;	lib/src/delay.c:14: }
      00014C 22               [24]  581 	ret
                                    582 ;------------------------------------------------------------
                                    ...
                                    590 ;	-----------------------------------------
      00014D                        591 _Delay_Ms:
      00014D AE 82            [24]  592 	mov	r6,dpl
      00014F AF 83            [24]  593 	mov	r7,dph
                                    594 ;	lib/src/delay.c:18: while (u16Delay) {
      000151                        595 00101$:
      000151 EE               [12]  596 	mov	a,r6
      000152 4F               [12]  597 	orl	a,r7
      000153 60 12            [24]  598 	jz	00104$
                                    599 ;	lib/src/delay.c:19: --u16Delay;
      000155 1E               [12]  600 	dec	r6
      000156 BE FF 01         [24]  601 	cjne	r6,#0xff,00116$
      000159 1F               [12]  602 	dec	r7
      00015A                        603 00116$:
                                    604 ;	lib/src/delay.c:20: delay_1ms();
      00015A C0 07            [24]  605 	push	ar7
      00015C C0 06            [24]  606 	push	ar6
      00015E 12 01 68         [24]  607 	lcall	_delay_1ms
      000161 D0 06            [24]  608 	pop	ar6
      000163 D0 07            [24]  609 	pop	ar7
      000165 80 EA            [24]  610 	sjmp	00101$
      000167                        611 00104$:
      ...
      000167 22               [24]  613 	ret
                                    ...
                                    620 ;	-----------------------------------------
      000168                        621 _delay_1ms:
                                    622 ;	lib/src/delay.c:26: TH0 = 0;
      000168 75 8C 00         [24]  623 	mov	_TH0,#0x00
                                    624 ;	lib/src/delay.c:27: TL0 = 0;
      00016B 75 8A 00         [24]  625 	mov	_TL0,#0x00
                                    626 ;	lib/src/delay.c:28: TR0 = 1;
                                    627 ;	assignBit
      00016E D2 8C            [12]  628 	setb	_TR0
                                    629 ;	lib/src/delay.c:29: while (TH0 * 256 + TL0 < 16000) {
      000170                        630 00101$:
      000170 AF 8C            [24]  631 	mov	r7,_TH0
      000172 7E 00            [12]  632 	mov	r6,#0x00
      000174 AC 8A            [24]  633 	mov	r4,_TL0
      000176 7D 00            [12]  634 	mov	r5,#0x00
      000178 EC               [12]  635 	mov	a,r4
      000179 2E               [12]  636 	add	a,r6
      00017A FE               [12]  637 	mov	r6,a
      00017B ED               [12]  638 	mov	a,r5
      00017C 3F               [12]  639 	addc	a,r7
      00017D FF               [12]  640 	mov	r7,a
      00017E C3               [12]  641 	clr	c
      00017F EE               [12]  642 	mov	a,r6
      000180 94 80            [12]  643 	subb	a,#0x80
      000182 EF               [12]  644 	mov	a,r7
      000183 64 80            [12]  645 	xrl	a,#0x80
      000185 94 BE            [12]  646 	subb	a,#0xbe
      000187 40 E7            [24]  647 	jc	00101$
                                    648 ;	lib/src/delay.c:31: TR0 = 0;
                                    649 ;	assignBit
      000189 C2 8C            [12]  650 	clr	_TR0
                                    651 ;	lib/src/delay.c:32: }
      00018B 22               [24]  652 	ret
                                    653 	.area CSEG    (CODE)
                                    654 	.area CONST   (CODE)
                                    655 	.area XINIT   (CODE)
