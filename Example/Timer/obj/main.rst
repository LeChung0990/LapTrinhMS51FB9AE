      ...
      000003 02 00 B1         [24]  574 	ljmp	_main
                                    ...
                                    579 	.area CSEG    (CODE)
                                    580 ;------------------------------------------------------------
                                    581 ;Allocation info for local variables in function 'Delay_Init'
                                    582 ;------------------------------------------------------------
                                    583 ;	main.c:5: void Delay_Init(void)
                                    584 ;	-----------------------------------------
                                    585 ;	 function Delay_Init
                                    586 ;	-----------------------------------------
      000062                        587 _Delay_Init:
                           000007   588 	ar7 = 0x07
                           000006   589 	ar6 = 0x06
                           000005   590 	ar5 = 0x05
                           000004   591 	ar4 = 0x04
                           ...
                           000001   594 	ar1 = 0x01
                           000000   595 	ar0 = 0x00
                                    596 ;	main.c:7: TMOD |= (1 << 0);
      000062 43 89 01         [24]  597 	orl	_TMOD,#0x01
                                    598 ;	main.c:8: TMOD &= ~(1 << 1);
      000065 53 89 FD         [24]  599 	anl	_TMOD,#0xfd
                                    600 ;	main.c:9: CKCON |= (1 << 3);
      000068 43 8E 08         [24]  601 	orl	_CKCON,#0x08
                                    602 ;	main.c:10: TMOD &= ~(1 << 2);
      00006B 53 89 FB         [24]  603 	anl	_TMOD,#0xfb
                                    604 ;	main.c:11: TMOD &= ~(1 << 3);
      00006E 53 89 F7         [24]  605 	anl	_TMOD,#0xf7
                                    606 ;	main.c:12: }
      000071 22               [24]  607 	ret
                                    608 ;------------------------------------------------------------
                                    609 ;Allocation info for local variables in function 'delay_1ms'
                                    610 ;------------------------------------------------------------
                                    611 ;	main.c:13: void delay_1ms(void)
                                    612 ;	-----------------------------------------
                                    613 ;	 function delay_1ms
                                    614 ;	-----------------------------------------
      000072                        615 _delay_1ms:
                                    616 ;	main.c:15: TH0 = 0;
      000072 75 8C 00         [24]  617 	mov	_TH0,#0x00
                                    618 ;	main.c:16: TL0 = 0;
      000075 75 8A 00         [24]  619 	mov	_TL0,#0x00
                                    620 ;	main.c:17: TR0 = 1;
                                    621 ;	assignBit
      000078 D2 8C            [12]  622 	setb	_TR0
                                    623 ;	main.c:18: while (TH0 * 256 + TL0 < 16000) {
      00007A                        624 00101$:
      00007A AF 8C            [24]  625 	mov	r7,_TH0
      00007C 7E 00            [12]  626 	mov	r6,#0x00
      00007E AC 8A            [24]  627 	mov	r4,_TL0
      000080 7D 00            [12]  628 	mov	r5,#0x00
      000082 EC               [12]  629 	mov	a,r4
      000083 2E               [12]  630 	add	a,r6
      000084 FE               [12]  631 	mov	r6,a
      000085 ED               [12]  632 	mov	a,r5
      000086 3F               [12]  633 	addc	a,r7
      000087 FF               [12]  634 	mov	r7,a
      000088 C3               [12]  635 	clr	c
      000089 EE               [12]  636 	mov	a,r6
      00008A 94 80            [12]  637 	subb	a,#0x80
      00008C EF               [12]  638 	mov	a,r7
      00008D 64 80            [12]  639 	xrl	a,#0x80
      00008F 94 BE            [12]  640 	subb	a,#0xbe
      000091 40 E7            [24]  641 	jc	00101$
                                    642 ;	main.c:20: TR0 = 0;
                                    643 ;	assignBit
      000093 C2 8C            [12]  644 	clr	_TR0
                                    645 ;	main.c:21: }
      000095 22               [24]  646 	ret
                                    647 ;------------------------------------------------------------
                                    648 ;Allocation info for local variables in function 'Delay_Ms'
                                    649 ;------------------------------------------------------------
                                    650 ;u16Delay                  Allocated to registers 
                                    651 ;------------------------------------------------------------
                                    652 ;	main.c:23: void Delay_Ms(uint16_t u16Delay)
                                    653 ;	-----------------------------------------
                                    654 ;	 function Delay_Ms
                                    655 ;	-----------------------------------------
      000096                        656 _Delay_Ms:
      000096 AE 82            [24]  657 	mov	r6,dpl
      000098 AF 83            [24]  658 	mov	r7,dph
                                    659 ;	main.c:25: while (u16Delay) {
      00009A                        660 00101$:
      00009A EE               [12]  661 	mov	a,r6
      00009B 4F               [12]  662 	orl	a,r7
      00009C 60 12            [24]  663 	jz	00104$
                                    664 ;	main.c:26: --u16Delay;
      00009E 1E               [12]  665 	dec	r6
      00009F BE FF 01         [24]  666 	cjne	r6,#0xff,00116$
      0000A2 1F               [12]  667 	dec	r7
      0000A3                        668 00116$:
                                    669 ;	main.c:27: delay_1ms();
      0000A3 C0 07            [24]  670 	push	ar7
      0000A5 C0 06            [24]  671 	push	ar6
      0000A7 12 00 72         [24]  672 	lcall	_delay_1ms
      0000AA D0 06            [24]  673 	pop	ar6
      0000AC D0 07            [24]  674 	pop	ar7
      0000AE 80 EA            [24]  675 	sjmp	00101$
      0000B0                        676 00104$:
                                    677 ;	main.c:29: }
      0000B0 22               [24]  678 	ret
                                    679 ;------------------------------------------------------------
                                    680 ;Allocation info for local variables in function 'main'
                                    681 ;------------------------------------------------------------
                                    682 ;	main.c:30: void main(void)
                                    683 ;	-----------------------------------------
                                    684 ;	 function main
                                    685 ;	-----------------------------------------
      0000B1                        686 _main:
                                    687 ;	main.c:34: P1M1&=0xDF;P1M2|=0x20;
      0000B1 53 B3 DF         [24]  688 	anl	_P1M1,#0xdf
      0000B4 43 B4 20         [24]  689 	orl	_P1M2,#0x20
                                    690 ;	main.c:35: Delay_Init();
      0000B7 12 00 62         [24]  691 	lcall	_Delay_Init
                                    692 ;	main.c:36: while (1) {
      0000BA                        693 00102$:
                                    694 ;	main.c:38: P15 = 0;
                                    695 ;	assignBit
      0000BA C2 95            [12]  696 	clr	_P15
                                    697 ;	main.c:39: Delay_Ms(1);
      0000BC 90 00 01         [24]  698 	mov	dptr,#0x0001
      0000BF 12 00 96         [24]  699 	lcall	_Delay_Ms
                                    700 ;	main.c:41: P15 = 1;
                                    701 ;	assignBit
      0000C2 D2 95            [12]  702 	setb	_P15
                                    703 ;	main.c:42: Delay_Ms(1);
      0000C4 90 00 01         [24]  704 	mov	dptr,#0x0001
      0000C7 12 00 96         [24]  705 	lcall	_Delay_Ms
                                    706 ;	main.c:45: }
      0000CA 80 EE            [24]  707 	sjmp	00102$
                                    708 	.area CSEG    (CODE)
                                    709 	.area CONST   (CODE)
                                    710 	.area XINIT   (CODE)
