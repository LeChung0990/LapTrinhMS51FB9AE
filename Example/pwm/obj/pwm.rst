      ...
      000000                        490 	.ds 8
                                    ...
                                    552 	.area CSEG    (CODE)
                                    553 ;------------------------------------------------------------
                                    554 ;Allocation info for local variables in function 'PWM_Init'
                                    555 ;------------------------------------------------------------
                                    556 ;	lib/src/pwm.c:4: void PWM_Init(void)
                                    557 ;	-----------------------------------------
                                    558 ;	 function PWM_Init
                                    559 ;	-----------------------------------------
      0000D3                        560 _PWM_Init:
                           000007   561 	ar7 = 0x07
                           000006   562 	ar6 = 0x06
                           000005   563 	ar5 = 0x05
                           000004   564 	ar4 = 0x04
                           ...
                           000001   567 	ar1 = 0x01
                           000000   568 	ar0 = 0x00
                                    569 ;	lib/src/pwm.c:6: CLRPWM = 1;
                                    570 ;	assignBit
      0000D3 D2 DC            [12]  571 	setb	_CLRPWM
                                    572 ;	lib/src/pwm.c:7: CKCON &= ~(1 << 6);
      0000D5 53 8E BF         [24]  573 	anl	_CKCON,#0xbf
                                    574 ;	lib/src/pwm.c:8: PWMCON1 &= 0x07;
      0000D8 53 DF 07         [24]  575 	anl	_PWMCON1,#0x07
                                    576 ;	lib/src/pwm.c:9: PWMCON1 |= 0x00;
      0000DB 85 DF DF         [24]  577 	mov	_PWMCON1,_PWMCON1
                                    578 ;	lib/src/pwm.c:10: PWMPH = 0x3e;
      0000DE 75 D1 3E         [24]  579 	mov	_PWMPH,#0x3e
                                    580 ;	lib/src/pwm.c:11: PWMPL = 0x7f;
      0000E1 75 D9 7F         [24]  581 	mov	_PWMPL,#0x7f
                                    582 ;	lib/src/pwm.c:12: PWM0H = 0x1f;
      0000E4 75 D2 1F         [24]  583 	mov	_PWM0H,#0x1f
                                    584 ;	lib/src/pwm.c:13: PWM0L = 0x40;
      0000E7 75 DA 40         [24]  585 	mov	_PWM0L,#0x40
                                    586 ;	lib/src/pwm.c:14: P1M1 &= ~(1 << 2);
      0000EA 53 B3 FB         [24]  587 	anl	_P1M1,#0xfb
                                    588 ;	lib/src/pwm.c:15: P1M2 |= (1 << 2);
      0000ED 43 B4 04         [24]  589 	orl	_P1M2,#0x04
                                    590 ;	lib/src/pwm.c:16: PIOCON0 |= (1 << 0);
      0000F0 43 DE 01         [24]  591 	orl	_PIOCON0,#0x01
                                    592 ;	lib/src/pwm.c:17: PWMRUN = 1;
                                    593 ;	assignBit
      0000F3 D2 DF            [12]  594 	setb	_PWMRUN
                                    595 ;	lib/src/pwm.c:18: }
      0000F5 22               [24]  596 	ret
                                    597 	.area CSEG    (CODE)
                                    598 	.area CONST   (CODE)
                                    599 	.area XINIT   (CODE)
