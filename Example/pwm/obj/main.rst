      ...
      000000 02 00 06         [24]  560 	ljmp	__sdcc_gsinit_startup
                                    ...
                                    574 ;	main.c:7: uint8_t dem = 0;
      00005F 75 08 00         [24]  575 	mov	_dem,#0x00
                                    576 	.area GSFINAL (CODE)
      000062 02 00 03         [24]  577 	ljmp	__sdcc_program_startup
                                    578 ;--------------------------------------------------------
                                    579 ; Home
                                    580 ;--------------------------------------------------------
                                    581 	.area HOME    (CODE)
                                    582 	.area HOME    (CODE)
      000003                        583 __sdcc_program_startup:
      000003 02 00 8C         [24]  584 	ljmp	_main
                                    ...
                                    592 ;------------------------------------------------------------
                                    593 ;i                         Allocated to registers r4 r5 r6 r7 
                                    594 ;------------------------------------------------------------
                                    595 ;	main.c:9: void delay(void)
                                    596 ;	-----------------------------------------
                                    597 ;	 function delay
                                    598 ;	-----------------------------------------
      000065                        599 _delay:
                           ...
                           000001   606 	ar1 = 0x01
                           000000   607 	ar0 = 0x00
                                    608 ;	main.c:11: for (uint32_t i = 0; i < 0xffff; ++i)
      000065 7C 00            [12]  609 	mov	r4,#0x00
      000067 7D 00            [12]  610 	mov	r5,#0x00
      000069 7E 00            [12]  611 	mov	r6,#0x00
      00006B 7F 00            [12]  612 	mov	r7,#0x00
      00006D                        613 00103$:
      00006D C3               [12]  614 	clr	c
      00006E EC               [12]  615 	mov	a,r4
      00006F 94 FF            [12]  616 	subb	a,#0xff
      000071 ED               [12]  617 	mov	a,r5
      000072 94 FF            [12]  618 	subb	a,#0xff
      000074 EE               [12]  619 	mov	a,r6
      000075 94 00            [12]  620 	subb	a,#0x00
      000077 EF               [12]  621 	mov	a,r7
      000078 94 00            [12]  622 	subb	a,#0x00
      00007A 50 0F            [24]  623 	jnc	00105$
      00007C 0C               [12]  624 	inc	r4
      00007D BC 00 09         [24]  625 	cjne	r4,#0x00,00117$
      000080 0D               [12]  626 	inc	r5
      000081 BD 00 05         [24]  627 	cjne	r5,#0x00,00117$
      000084 0E               [12]  628 	inc	r6
      000085 BE 00 E5         [24]  629 	cjne	r6,#0x00,00103$
      000088 0F               [12]  630 	inc	r7
      000089                        631 00117$:
      000089 80 E2            [24]  632 	sjmp	00103$
      00008B                        633 00105$:
                                    634 ;	main.c:14: }
      00008B 22               [24]  635 	ret
                                    636 ;------------------------------------------------------------
                                    637 ;Allocation info for local variables in function 'main'
                                    638 ;------------------------------------------------------------
                                    639 ;	main.c:15: void main(void)
                                    640 ;	-----------------------------------------
                                    641 ;	 function main
                                    642 ;	-----------------------------------------
      00008C                        643 _main:
                                    644 ;	main.c:18: GPIO_Init();
      00008C 12 00 A8         [24]  645 	lcall	_GPIO_Init
                                    646 ;	main.c:20: Delay_Init();
      00008F 12 00 B5         [24]  647 	lcall	_Delay_Init
                                    648 ;	main.c:21: PWM_Init();
      000092 12 01 04         [24]  649 	lcall	_PWM_Init
                                    650 ;	main.c:22: while (1)
      000095                        651 00104$:
                                    652 ;	main.c:24: if (P10 == 0)
      000095 20 90 FD         [24]  653 	jb	_P10,00104$
                                    654 ;	main.c:26: P15 = 1;
                                    655 ;	assignBit
      000098 D2 95            [12]  656 	setb	_P15
                                    657 ;	main.c:27: PWM0_STOP();
      00009A 12 01 2A         [24]  658 	lcall	_PWM0_STOP
                                    659 ;	main.c:28: SET_DUTY(90);
      00009D 75 82 5A         [24]  660 	mov	dpl,#0x5a
      0000A0 12 01 2D         [24]  661 	lcall	_SET_DUTY
                                    662 ;	main.c:29: PWM0_RUN();
      0000A3 12 01 27         [24]  663 	lcall	_PWM0_RUN
                                    664 ;	main.c:33: }
      0000A6 80 ED            [24]  665 	sjmp	00104$
                                    666 	.area CSEG    (CODE)
                                    667 	.area CONST   (CODE)
                                    668 	.area XINIT   (CODE)
