      ...
      000000 02 00 06         [24]  554 	ljmp	__sdcc_gsinit_startup
                                    ...
                                    568 ;	main.c:7: uint8_t dem = 0;
      00005F 75 08 00         [24]  569 	mov	_dem,#0x00
                                    570 	.area GSFINAL (CODE)
      000062 02 00 03         [24]  571 	ljmp	__sdcc_program_startup
                                    572 ;--------------------------------------------------------
                                    573 ; Home
                                    574 ;--------------------------------------------------------
                                    575 	.area HOME    (CODE)
      ...
      000003 02 00 8C         [24]  578 	ljmp	_main
                                    ...
                                    586 ;------------------------------------------------------------
                                    587 ;i                         Allocated to registers r4 r5 r6 r7 
                                    588 ;------------------------------------------------------------
                                    589 ;	main.c:9: void delay(void)
                                    590 ;	-----------------------------------------
                                    591 ;	 function delay
                                    592 ;	-----------------------------------------
      000065                        593 _delay:
                           ...
                           000001   600 	ar1 = 0x01
                           000000   601 	ar0 = 0x00
                                    602 ;	main.c:11: for (uint32_t i = 0; i < 0xffff; ++i)
      000065 7C 00            [12]  603 	mov	r4,#0x00
      000067 7D 00            [12]  604 	mov	r5,#0x00
      000069 7E 00            [12]  605 	mov	r6,#0x00
      00006B 7F 00            [12]  606 	mov	r7,#0x00
      00006D                        607 00103$:
      00006D C3               [12]  608 	clr	c
      00006E EC               [12]  609 	mov	a,r4
      00006F 94 FF            [12]  610 	subb	a,#0xff
      000071 ED               [12]  611 	mov	a,r5
      000072 94 FF            [12]  612 	subb	a,#0xff
      000074 EE               [12]  613 	mov	a,r6
      000075 94 00            [12]  614 	subb	a,#0x00
      000077 EF               [12]  615 	mov	a,r7
      000078 94 00            [12]  616 	subb	a,#0x00
      00007A 50 0F            [24]  617 	jnc	00105$
      00007C 0C               [12]  618 	inc	r4
      00007D BC 00 09         [24]  619 	cjne	r4,#0x00,00117$
      000080 0D               [12]  620 	inc	r5
      000081 BD 00 05         [24]  621 	cjne	r5,#0x00,00117$
      000084 0E               [12]  622 	inc	r6
      000085 BE 00 E5         [24]  623 	cjne	r6,#0x00,00103$
      000088 0F               [12]  624 	inc	r7
      000089                        625 00117$:
      000089 80 E2            [24]  626 	sjmp	00103$
      00008B                        627 00105$:
                                    628 ;	main.c:14: }
      00008B 22               [24]  629 	ret
                                    630 ;------------------------------------------------------------
                                    631 ;Allocation info for local variables in function 'main'
                                    632 ;------------------------------------------------------------
                                    633 ;	main.c:15: void main(void)
                                    634 ;	-----------------------------------------
                                    635 ;	 function main
                                    636 ;	-----------------------------------------
      00008C                        637 _main:
                                    638 ;	main.c:23: CLRPWM = 1;
                                    639 ;	assignBit
      00008C D2 DC            [12]  640 	setb	_CLRPWM
                                    641 ;	main.c:24: CKCON &= ~(1 << 6);
      00008E 53 8E BF         [24]  642 	anl	_CKCON,#0xbf
                                    643 ;	main.c:25: PWMCON1 &= 0x07;
      000091 53 DF 07         [24]  644 	anl	_PWMCON1,#0x07
                                    645 ;	main.c:26: PWMCON1 |= 0x00;
      000094 85 DF DF         [24]  646 	mov	_PWMCON1,_PWMCON1
                                    647 ;	main.c:27: PWMPH = 0x1;
      000097 75 D1 01         [24]  648 	mov	_PWMPH,#0x01
                                    649 ;	main.c:28: PWMPL = 0x3f;
      00009A 75 D9 3F         [24]  650 	mov	_PWMPL,#0x3f
                                    651 ;	main.c:29: PWM0H = 0x0;
      00009D 75 D2 00         [24]  652 	mov	_PWM0H,#0x00
                                    653 ;	main.c:30: PWM0L = 0x20;
      0000A0 75 DA 20         [24]  654 	mov	_PWM0L,#0x20
                                    655 ;	main.c:31: P1M1 &= ~(1 << 2);
      0000A3 53 B3 FB         [24]  656 	anl	_P1M1,#0xfb
                                    657 ;	main.c:32: P1M2 |= (1 << 2);
      0000A6 43 B4 04         [24]  658 	orl	_P1M2,#0x04
                                    659 ;	main.c:33: PIOCON0 |= (1 << 0);
      0000A9 43 DE 01         [24]  660 	orl	_PIOCON0,#0x01
                                    661 ;	main.c:34: PWM1H = 0x0;
      0000AC 75 D3 00         [24]  662 	mov	_PWM1H,#0x00
                                    663 ;	main.c:35: PWM1L = 0x40;
      0000AF 75 DB 40         [24]  664 	mov	_PWM1L,#0x40
                                    665 ;	main.c:36: P1M1 &= ~(1 << 1);
      0000B2 53 B3 FD         [24]  666 	anl	_P1M1,#0xfd
                                    667 ;	main.c:37: P1M2 |= (1 << 1);
      0000B5 43 B4 02         [24]  668 	orl	_P1M2,#0x02
                                    669 ;	main.c:38: PIOCON0 |= (1 << 1);
      0000B8 43 DE 02         [24]  670 	orl	_PIOCON0,#0x02
                                    671 ;	main.c:39: PWM2H = 0x0;
      0000BB 75 D4 00         [24]  672 	mov	_PWM2H,#0x00
                                    673 ;	main.c:40: PWM2L = 0x60;
      0000BE 75 DC 60         [24]  674 	mov	_PWM2L,#0x60
                                    675 ;	main.c:41: P1M1 &= ~(1 << 0);
      0000C1 53 B3 FE         [24]  676 	anl	_P1M1,#0xfe
                                    677 ;	main.c:42: P1M2 |= (1 << 0);
      0000C4 43 B4 01         [24]  678 	orl	_P1M2,#0x01
                                    679 ;	main.c:43: PIOCON0 |= (1 << 2);
      0000C7 43 DE 04         [24]  680 	orl	_PIOCON0,#0x04
                                    681 ;	main.c:44: PWM3H = 0x0;
      0000CA 75 D5 00         [24]  682 	mov	_PWM3H,#0x00
                                    683 ;	main.c:45: PWM3L = 0x80;
      0000CD 75 DD 80         [24]  684 	mov	_PWM3L,#0x80
                                    685 ;	main.c:46: P0M1 &= ~(1 << 0);
      0000D0 53 B1 FE         [24]  686 	anl	_P0M1,#0xfe
                                    687 ;	main.c:47: P0M2 |= (1 << 0);
      0000D3 43 B2 01         [24]  688 	orl	_P0M2,#0x01
                                    689 ;	main.c:48: PIOCON0 |= (1 << 3);
      0000D6 43 DE 08         [24]  690 	orl	_PIOCON0,#0x08
                                    691 ;	main.c:49: PWMRUN = 1;
                                    692 ;	assignBit
      0000D9 D2 DF            [12]  693 	setb	_PWMRUN
                                    694 ;	main.c:50: while (1)
      0000DB                        695 00102$:
                                    696 ;	main.c:61: }
      0000DB 80 FE            [24]  697 	sjmp	00102$
                                    698 	.area CSEG    (CODE)
                                    699 	.area CONST   (CODE)
                                    700 	.area XINIT   (CODE)
