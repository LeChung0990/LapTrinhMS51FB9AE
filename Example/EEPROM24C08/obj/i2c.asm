...
;------------------------------------------------------------
;	lib/src/i2c.c:84: uint8_t I2C_Address(uint8_t Address, uint8_t WriteRead){ 
;	-----------------------------------------
;	 function I2C_Address
;	-----------------------------------------
_I2C_Address:
	mov	r7,dpl
;	lib/src/i2c.c:87: STA = 0;
;	assignBit
	clr	_STA
;	lib/src/i2c.c:88: STO = 0;
;	assignBit
	clr	_STO
;	lib/src/i2c.c:89: I2DAT = Address;
	mov	_I2DAT,r7
;	lib/src/i2c.c:90: SI = 0;
;	assignBit
	clr	_SI
;	lib/src/i2c.c:91: while (!SI);
00101$:
	jnb	_SI,00101$
;	lib/src/i2c.c:92: if(WriteRead)	/*Read*/
	mov	a,_I2C_Address_PARM_2
	jz	00109$
;	lib/src/i2c.c:95: if (I2STAT != 0x40) {
	mov	a,#0x40
	cjne	a,_I2STAT,00135$
	sjmp	00105$
00135$:
;	lib/src/i2c.c:97: send_stop();
	lcall	_send_stop
;	lib/src/i2c.c:98: return 0;
	mov	dpl,#0x00
	ret
00105$:
;	lib/src/i2c.c:100: return 1;
	mov	dpl,#0x01
	ret
00109$:
;	lib/src/i2c.c:106: if (I2STAT != 0x18) {
	mov	a,#0x18
	cjne	a,_I2STAT,00136$
	sjmp	00107$
00136$:
;	lib/src/i2c.c:108: send_stop();
	lcall	_send_stop
;	lib/src/i2c.c:109: return 0;
	mov	dpl,#0x00
	ret
00107$:
;	lib/src/i2c.c:111: return 1;
	mov	dpl,#0x01
;	lib/src/i2c.c:113: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	lib/src/i2c.c:114: uint8_t I2C_Write(uint8_t u8Data)
;	-----------------------------------------
;	 function I2C_Write
;	-----------------------------------------
_I2C_Write:
	mov	_I2DAT,dpl
;	lib/src/i2c.c:118: SI = 0;
;	assignBit
	clr	_SI
;	lib/src/i2c.c:119: while (!SI);
00101$:
	jnb	_SI,00101$
;	lib/src/i2c.c:121: if (I2STAT != 0x28) {
	mov	a,#0x28
	cjne	a,_I2STAT,00121$
	ret
00121$:
;	lib/src/i2c.c:123: send_stop();
	lcall	_send_stop
;	lib/src/i2c.c:124: return 0;
	mov	dpl,#0x00
;	lib/src/i2c.c:126: }
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;	lib/src/i2c.c:127: uint8_t I2C_Write_nByte(uint8_t *pData, uint8_t length)
;	-----------------------------------------
...
_I2C_Write_nByte:
	...
	mov	r6,dph
	mov	r7,b
;	lib/src/i2c.c:131: for (i = 0; i < length; ++i) {
	mov	r4,#0x00
00108$:
	clr	c
	mov	a,r4
	...
	jnc	00110$
;	lib/src/i2c.c:132: I2DAT = pData[i];
	mov	a,r4
	add	a,r5
	mov	r1,a
	clr	a
	...
	lcall	__gptrget
	mov	_I2DAT,a
;	lib/src/i2c.c:133: SI = 0;
;	assignBit
	clr	_SI
;	lib/src/i2c.c:134: while (!SI);
00101$:
	jnb	_SI,00101$
;	lib/src/i2c.c:135: if (I2STAT != 0x28) {
	mov	a,#0x28
	cjne	a,_I2STAT,00134$
	sjmp	00109$
00134$:
;	lib/src/i2c.c:137: send_stop();
	lcall	_send_stop
;	lib/src/i2c.c:138: return 0;
	mov	dpl,#0x00
	ret
00109$:
;	lib/src/i2c.c:131: for (i = 0; i < length; ++i) {
...
;u8Data                    Allocated to registers 
;------------------------------------------------------------
;	lib/src/i2c.c:148: uint8_t I2C_Read(uint8_t AckNack) 
;	-----------------------------------------
;	 function I2C_Read
;	-----------------------------------------
_I2C_Read:
;	lib/src/i2c.c:151: if(AckNack)
	mov	a,dpl
	mov	r7,a
	jz	00112$
;	lib/src/i2c.c:153: AA = 1;
;	assignBit
	setb	_AA
;	lib/src/i2c.c:154: SI = 0;
;	assignBit
	clr	_SI
;	lib/src/i2c.c:155: while (!SI);
00101$:
	jnb	_SI,00101$
;	lib/src/i2c.c:156: if (I2STAT != 0x50) { /*Master Receive Data ACK*/
	mov	a,#0x50
	cjne	a,_I2STAT,00153$
	sjmp	00105$
00153$:
;	lib/src/i2c.c:158: send_stop();
	lcall	_send_stop
;	lib/src/i2c.c:159: return 0;
	mov	dpl,#0x00
	ret
00105$:
;	lib/src/i2c.c:161: u8Data = I2DAT;
	mov	dpl,_I2DAT
;	lib/src/i2c.c:162: return u8Data;
	ret
00112$:
;	lib/src/i2c.c:166: AA = 0;
;	assignBit
	clr	_AA
;	lib/src/i2c.c:167: SI = 0;
;	assignBit
	clr	_SI
;	lib/src/i2c.c:168: while (!SI);
00106$:
	jnb	_SI,00106$
;	lib/src/i2c.c:169: if (I2STAT != 0x58) { /*Master Receive Data NACK*/
	mov	a,#0x58
	cjne	a,_I2STAT,00155$
	sjmp	00110$
00155$:
;	lib/src/i2c.c:171: send_stop();
	lcall	_send_stop
;	lib/src/i2c.c:172: return 0;
	mov	dpl,#0x00
	ret
00110$:
;	lib/src/i2c.c:174: u8Data = I2DAT;
	mov	dpl,_I2DAT
;	lib/src/i2c.c:175: return u8Data;
;	lib/src/i2c.c:177: }
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
