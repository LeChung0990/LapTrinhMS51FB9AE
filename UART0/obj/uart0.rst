      ...
      0000D8 43 C4 20         [24]  579 	orl	_T3CON,#0x20
                                    580 ;	lib/src/uart0.c:11: T3CON &= ~0x07;
      0000DB 53 C4 F8         [24]  581 	anl	_T3CON,#0xf8
                                    582 ;	lib/src/uart0.c:12: T3CON |= 0x00;
      0000DE 85 C4 C4         [24]  583 	mov	_T3CON,_T3CON
                                    584 ;	lib/src/uart0.c:14: EIE1 &= ~(1 << 1);
      0000E1 53 9C FD         [24]  585 	anl	_EIE1,#0xfd
                                    586 ;	lib/src/uart0.c:15: RH3 = 0xff;
      0000E4 75 C6 FF         [24]  587 	mov	_RH3,#0xff
                                    588 ;	lib/src/uart0.c:16: RL3 = 0xf7;
      0000E7 75 C5 F7         [24]  589 	mov	_RL3,#0xf7
                                    590 ;	lib/src/uart0.c:17: T3CON |= (1 << 3);
      0000EA 43 C4 08         [24]  591 	orl	_T3CON,#0x08
                                    592 ;	lib/src/uart0.c:18: PCON |= (1 << 7);
      0000ED 43 87 80         [24]  593 	orl	_PCON,#0x80
                                    594 ;	lib/src/uart0.c:20: P06 = 1;
                                    595 ;	assignBit
      0000F0 D2 86            [12]  596 	setb	_P06
                                    597 ;	lib/src/uart0.c:21: P0M1 &= ~(1 << 6);
      0000F2 53 B1 BF         [24]  598 	anl	_P0M1,#0xbf
                                    599 ;	lib/src/uart0.c:22: P0M2 |= (1 << 6);
      0000F5 43 B2 40         [24]  600 	orl	_P0M2,#0x40
                                    601 ;	lib/src/uart0.c:23: P07 = 1;
                                    602 ;	assignBit
      0000F8 D2 87            [12]  603 	setb	_P07
                                    604 ;	lib/src/uart0.c:24: P0M1 &= ~(1 << 7);
      0000FA 53 B1 7F         [24]  605 	anl	_P0M1,#0x7f
                                    606 ;	lib/src/uart0.c:25: P0M2 &= ~(1 << 7);
      0000FD 53 B2 7F         [24]  607 	anl	_P0M2,#0x7f
                                    608 ;	lib/src/uart0.c:27: PCON &= ~(1 << 6);
      000100 53 87 BF         [24]  609 	anl	_PCON,#0xbf
                                    610 ;	lib/src/uart0.c:28: SM0 = 0;
                                    611 ;	assignBit
      000103 C2 9F            [12]  612 	clr	_SM0
                                    613 ;	lib/src/uart0.c:29: SM1 = 1;
                                    614 ;	assignBit
      000105 D2 9E            [12]  615 	setb	_SM1
                                    616 ;	lib/src/uart0.c:31: REN = 1;
                                    617 ;	assignBit
      000107 D2 9C            [12]  618 	setb	_REN
                                    619 ;	lib/src/uart0.c:32: }
      000109 22               [24]  620 	ret
                                    621 ;------------------------------------------------------------
                                    ...
                                    629 ;	-----------------------------------------
      00010A                        630 _UART0_SendData:
      00010A 85 82 99         [24]  631 	mov	_SBUF,dpl
                                    632 ;	lib/src/uart0.c:36: SBUF = u8Data;
                                    633 ;	lib/src/uart0.c:37: }
      00010D 22               [24]  634 	ret
                                    635 ;------------------------------------------------------------
                                    ...
                                    641 ;	-----------------------------------------
      00010E                        642 _UART0_GetData:
                                    643 ;	lib/src/uart0.c:41: return SBUF;
      00010E 85 99 82         [24]  644 	mov	dpl,_SBUF
                                    645 ;	lib/src/uart0.c:42: }
      000111 22               [24]  646 	ret
                                    647 ;------------------------------------------------------------
                                    ...
                                    653 ;	-----------------------------------------
      000112                        654 _UART0_EnableInterrupt:
                                    655 ;	lib/src/uart0.c:46: ES = 1;
                                    656 ;	assignBit
      000112 D2 AC            [12]  657 	setb	_ES
                                    658 ;	lib/src/uart0.c:47: }
      000114 22               [24]  659 	ret
                                    660 ;------------------------------------------------------------
                                    ...
                                    666 ;	-----------------------------------------
      000115                        667 _UART0_DisableInterrupt:
                                    668 ;	lib/src/uart0.c:51: ES = 0;
                                    669 ;	assignBit
      000115 C2 AC            [12]  670 	clr	_ES
                                    671 ;	lib/src/uart0.c:52: }
      000117 22               [24]  672 	ret
                                    673 ;------------------------------------------------------------
                                    ...
                                    681 ;	-----------------------------------------
      000118                        682 _UART0_ClearFlag:
                                    683 ;	lib/src/uart0.c:56: SCON &= ~(u8Flag);
      000118 E5 82            [12]  684 	mov	a,dpl
      00011A F4               [12]  685 	cpl	a
      00011B 52 98            [12]  686 	anl	_SCON,a
                                    687 ;	lib/src/uart0.c:57: }
      00011D 22               [24]  688 	ret
                                    689 ;------------------------------------------------------------
                                    ...
                                    697 ;	-----------------------------------------
      00011E                        698 _UART0_GetFlag:
                                    699 ;	lib/src/uart0.c:61: if (SCON & (u8Flag)) {
      00011E E5 82            [12]  700 	mov	a,dpl
      000120 55 98            [12]  701 	anl	a,_SCON
      000122 60 04            [24]  702 	jz	00102$
                                    703 ;	lib/src/uart0.c:62: return 1;
      000124 75 82 01         [24]  704 	mov	dpl,#0x01
      000127 22               [24]  705 	ret
      000128                        706 00102$:
                                    707 ;	lib/src/uart0.c:64: return 0;
      000128 75 82 00         [24]  708 	mov	dpl,#0x00
                                    709 ;	lib/src/uart0.c:66: }
      00012B 22               [24]  710 	ret
                                    711 	.area CSEG    (CODE)
                                    712 	.area CONST   (CODE)
                                    713 	.area XINIT   (CODE)
