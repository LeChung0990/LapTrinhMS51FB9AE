      ...
      000062                        586 _main:
                           ...
                           000001   593 	ar1 = 0x01
                           000000   594 	ar0 = 0x00
                                    595 ;	main.c:11: set_P1M1_5;
      000062 43 B3 20         [24]  596 	orl	_P1M1,#0x20
                                    597 ;	main.c:12: set_P1M2_1; 
      000065 43 B4 02         [24]  598 	orl	_P1M2,#0x02
                                    599 ;	main.c:13: Delay_Init();
      000068 12 00 7D         [24]  600 	lcall	_Delay_Init
                                    601 ;	main.c:14: while (1) {
      00006B                        602 00102$:
                                    603 ;	main.c:15: P15 = 1;
                                    604 ;	assignBit
      00006B D2 95            [12]  605 	setb	_P15
                                    606 ;	main.c:16: Delay_Ms(1000);
      00006D 90 03 E8         [24]  607 	mov	dptr,#0x03e8
      000070 12 00 8D         [24]  608 	lcall	_Delay_Ms
                                    609 ;	main.c:17: P15 = 0;
                                    610 ;	assignBit
      000073 C2 95            [12]  611 	clr	_P15
                                    612 ;	main.c:18: Delay_Ms(1000);
      000075 90 03 E8         [24]  613 	mov	dptr,#0x03e8
      000078 12 00 8D         [24]  614 	lcall	_Delay_Ms
                                    615 ;	main.c:20: }
      00007B 80 EE            [24]  616 	sjmp	00102$
                                    617 	.area CSEG    (CODE)
                                    618 	.area CONST   (CODE)
                                    619 	.area XINIT   (CODE)
