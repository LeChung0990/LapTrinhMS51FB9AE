      ...
      000062                        586 _main:
                           ...
                           000001   593 	ar1 = 0x01
                           000000   594 	ar0 = 0x00
                                    595 ;	main.c:12: P15_PUSHPULL_MODE;
      000062 53 B3 DF         [24]  596 	anl	_P1M1,#0xdf
      000065 43 B4 20         [24]  597 	orl	_P1M2,#0x20
                                    598 ;	main.c:13: Delay_Init();
      000068 12 00 7D         [24]  599 	lcall	_Delay_Init
                                    600 ;	main.c:14: while (1)
      00006B                        601 00102$:
                                    602 ;	main.c:16: P15 = 1;
                                    603 ;	assignBit
      00006B D2 95            [12]  604 	setb	_P15
                                    605 ;	main.c:17: Delay_Ms(500);
      00006D 90 01 F4         [24]  606 	mov	dptr,#0x01f4
      000070 12 00 8D         [24]  607 	lcall	_Delay_Ms
                                    608 ;	main.c:18: P15 = 0;
                                    609 ;	assignBit
      000073 C2 95            [12]  610 	clr	_P15
                                    611 ;	main.c:19: Delay_Ms(500);
      000075 90 01 F4         [24]  612 	mov	dptr,#0x01f4
      000078 12 00 8D         [24]  613 	lcall	_Delay_Ms
                                    614 ;	main.c:21: }
      00007B 80 EE            [24]  615 	sjmp	00102$
                                    616 	.area CSEG    (CODE)
                                    617 	.area CONST   (CODE)
                                    618 	.area XINIT   (CODE)
